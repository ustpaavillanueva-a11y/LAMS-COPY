...
ng serve</code></pre>
    ...
    `, styles: ["/* angular:styles/component:scss;8e3f0b030d88dc23a8b89f67cf25473a98b55e2c985009a8d6c99cd68a094bfd;D:/Capstone Projects/LAMS-COPY/src/app/pages/documentation/documentation.ts */\n@media screen and (max-width: 991px) {\n  .video-container {\n    position: relative;\n    width: 100%;\n    height: 0;\n    padding-bottom: 56.25%;\n  }\n  .video-container iframe {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n  }\n}\n/*# sourceMappingURL=documentation.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
// src/app/pages/assets/assets.ts
var import_sweetalert22 = __toESM(require_sweetalert2_all());

// src/app/pages/assets/constants/asset.constants.ts
var AssetConstants = class {
  static CATEGORY_OPTIONS = [
    { label: "Software", value: "Software" },
    { label: "Hardware", value: "Hardware" }
  ];
  static SOFTWARE_CATEGORY = "Software";
  static HARDWARE_CATEGORY = "Hardware";
  static DEFAULT_EMPTY_ASSET = {
    assetName: "",
    propertyNumber: "",
    category: "",
    foundCluster: "",
   ...
   */
  static getShortAssetId(assetId) {
    if (!assetId)
      return "N/A";
...
// src/app/pages/assets/services/qr-code.service.ts
...
var QrCodeService = class _QrCodeService {
        ...
        reader.onload = (e) => {
          ...
          img.onload = () => {
            try {
              ...
              const decodedQR = (0, import_jsqr.default)(imageData.data, img.width, img.height);
              if (decodedQR) {
  ...
  static \u0275fac = function QrCodeService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _QrCodeService)(\u0275\u0275inject(MessageService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _QrCodeService, factory: _QrCodeService.\u0275fac });
};
(() => {
...
// src/app/pages/assets/services/asset-export.service.ts
var AssetExportService = class _AssetExportService {
  messageService;
  constructor(messageService) {
    this.messageService = messageService;
  }
   ...
   */
  exportToExcel(assets, selectedCampusId, campuses, brands = [], colors = [], programs = []) {
    ...
    const filename = `assets_${campusName}_${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.csv`;
   ...
   * Print assets list
   */
  printAssets(assets, selectedCampusId, campuses, brands = [], colors = [], programs = []) {
   ...
   */
  exportToPdf(assets, selectedCampusId, campuses, brands = [], colors = [], programs = []) {
    const campusName = selectedCampusId ? campuses.find((c) => c.campusId === selectedCampusId)?.campusName || "Filtered" : "All Campuses";
   ...
   */
  generatePrintContent(assets, campusName, isPdf, brands = [], colors = [], programs = []) {
  ...
  static \u0275fac = function AssetExportService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AssetExportService)(\u0275\u0275inject(MessageService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AssetExportService, factory: _AssetExportService.\u0275fac });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AssetExportService, [{
    type: Injectable
  }], () => [{ type: MessageService }], null);
})();

// src/app/pages/assets/services/asset-form.service.ts
var AssetFormService = class _AssetFormService {
  /**
   * Validate and parse serial numbers from raw input
   */
  validateSerialNumbers(rawInput, expectedQuantity) {
    const result = {
      isValid: false,
      parsed: [],
      error: "",
    ...
    console.log("\u{1F4DD} Parsing serials:", {
      raw: rawInput,
      tokens: rawTokens,
   ...
   */
  validateQrCodeUpload(qrCodeImage) {
    if (!qrCodeImage) {
   ...
   */
  extractStringValue(value, fieldName) {
    if (!value)
      return "";
   ...
   */
  prepareAssetForSubmission(asset, serialNumber) {
    const assetToSend = {
    ...
    Object.keys(assetToSend).forEach((key) => {
      if (assetToSend[key] === null || assetToSend[key] === void 0) {
        assetToSend[key] = "";
      }
    });
    Object.keys(assetToSend.inventoryCustodianSlip).forEach((key) => {
      if (assetToSend.inventoryCustodianSlip[key] === null || assetToSend.inventoryCustodianSlip[key] === void 0) {
        assetToSend.inventoryCustodianSlip[key] = typeof assetToSend.inventoryCustodianSlip[key] === "number" ? 0 : "";
      }
    });
    console.log("\u{1F4E4} Prepared asset for submission:", assetToSend);
    return assetToSend;
  }
  /**
  ...
  static \u0275fac = function AssetFormService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AssetFormService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AssetFormService, factory: _AssetFormService.\u0275fac });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AssetFormService, [{
    type: Injectable
  }], null, null);
})();

// src/app/pages/assets/utils/asset.utils.ts
var AssetUtils = class {
  /**
   * Get full name from user object
   */
   ...
   */
  static expandAssetsForDisplay(assets) {
    ...
    assets.forEach((asset) => {
      ...
      if (serialNumber && serialNumber.includes(",")) {
        const serials = serialNumber.split(",").map((s) => s.trim());
        console.log(`\u{1F4E6} Expanding asset ${asset.assetId}: ${serials.length} serials`);
        serials.forEach((serial, index) => {
          const expandedAsset = __spreadProps(__spreadValues({}, asset), {
            // Deep copy ICS to avoid reference issues
            inventoryCustodianSlip: __spreadProps(__spreadValues({}, asset.inventoryCustodianSlip), {
              serialNumber: serial,
              quantity: 1
            }),
   ...
   */
  static getIcsTableData(icsData) {
    if (!icsData)
      return [];
    const tableData = [];
    const fields = [
    ...
    fields.forEach((field) => {
      if (icsData[field.key] !== void 0 && icsData[field.key] !== null) {
        tableData.push({
          field: field.label,
   ...
   */
  static filterAssets(assets, searchTerm, selectedCampusId) {
    return assets.filter((asset) => {
      const searchLower = searchTerm.toLowerCase();
      const matchesSearch = !searchTerm || asset.assetId?.toLowerCase().includes(searchLower) || asset.assetName?.toLowerCase().includes(searchLower) || asset.propertyNumber?.toLowerCase().includes(searchLower) || asset.category?.toLowerCase().includes(searchLower) || asset.foundCluster?.toLowerCase().includes(searchLower) || asset.purpose?.toLowerCase().includes(searchLower) || asset.issuedTo?.toLowerCase().includes(searchLower) || asset.supplier?.toLowerCase().includes(searchLower) || asset.laboratories?.laboratoryName?.toLowerCase().includes(searchLower) || asset.campus?.campusName?.toLowerCase().includes(searchLower) || // Search in ICS details
      asset.inventoryCustodianSlip?.icsNo?.toLowerCase().includes(searchLower) || asset.inventoryCustodianSlip?.uoM?.toLowerCase().includes(searchLower) || asset.inventoryCustodianSlip?.description?.toLowerCase().includes(searchLower) || asset.inventoryCustodianSlip?.specifications?.toLowerCase().includes(searchLower) || asset.inventoryCustodianSlip?.package?.toLowerCase().includes(searchLower) || asset.inventoryCustodianSlip?.material?.toLowerCase().includes(searchLower) || asset.inventoryCustodianSlip?.serialNumber?.toLowerCase().includes(searchLower) || asset.inventoryCustodianSlip?.modelNumber?.toLowerCase().includes(searchLower) || asset.inventoryCustodianSlip?.estimatedUsefullLife?.toLowerCase().includes(searchLower);
   ...
   */
  static isSoftwareCategory(category) {
    return category === "Software";
  }
};

// src/app/pages/service/asset.service.ts
var AssetService = class _AssetService {
  http;
  apiUrl = `${environment.apiUrl}/assets`;
  baseApiUrl = environment.apiUrl;
  constructor(http) {
    this.http = http;
  }
  getAssets() {
    return this.http.get(this.apiUrl).pipe(tap());
  }
  getAsset(id) {
    return this.http.get(`${this.apiUrl}/${id}`);
  }
  getAssetsByCampus(campusId) {
    return this.http.get(`${this.apiUrl}/${campusId}`);
  }
  createAsset(asset) {
    return this.http.post(this.apiUrl, asset);
  }
  createAssetWithFile(formData) {
  ...
  patchAsset(id, asset) {
    return this.http.patch(`${this.apiUrl}/${id}`, asset);
  }
  deleteAsset(id) {
  ...
  getLocations() {
    return this.http.get(`${this.baseApiUrl}/locations`).pipe(tap((data) => console.log("\u2705 getLocations API Response:", data)));
  }
  createLocation(body) {
    return this.http.post(`${this.baseApiUrl}/locations`, body);
  }
  updateLocation(id, body) {
    return this.http.put(`${this.baseApiUrl}/locations/${id}`, body);
  }
  deleteLocation(id) {
    return this.http.delete(`${this.baseApiUrl}/locations/${id}`);
  }
  getSuppliers() {
    return this.http.get(`${this.baseApiUrl}/suppliers`).pipe(tap((data) => console.log("\u2705 getSuppliers API Response:", data)));
  }
  createSupplier(body) {
    return this.http.post(`${this.baseApiUrl}/suppliers`, body);
  }
  updateSupplier(id, body) {
    return this.http.put(`${this.baseApiUrl}/suppliers/${id}`, body);
  }
  deleteSupplier(id) {
    return this.http.delete(`${this.baseApiUrl}/suppliers/${id}`);
  }
  getPrograms() {
    return this.http.get(`${this.baseApiUrl}/programs`).pipe(tap((data) => console.log("\u2705 getPrograms API Response:", data)));
  }
  createProgram(body) {
    return this.http.post(`${this.baseApiUrl}/programs`, body);
  }
  updateProgram(id, body) {
    return this.http.patch(`${this.baseApiUrl}/programs/${id}`, body);
  }
  deleteProgram(id) {
    return this.http.delete(`${this.baseApiUrl}/programs/${id}`);
  }
  getStatuses() {
    return this.http.get(`${this.baseApiUrl}/status`).pipe(tap((data) => console.log("\u2705 getStatuses API Response:", data)));
  }
  createStatus(body) {
    return this.http.post(`${this.baseApiUrl}/status`, body);
  }
  updateStatus(id, body) {
    return this.http.put(`${this.baseApiUrl}/status/${id}`, body);
  }
  deleteStatus(id) {
    return this.http.delete(`${this.baseApiUrl}/status/${id}`);
  }
  // InvCustlips methods
  getInvCustlips() {
    return this.http.get(`${this.baseApiUrl}/InvCustlips`);
  }
  getInvCustlip(id) {
    return this.http.get(`${this.baseApiUrl}/InvCustlips/${id}`);
  }
  createInvCustlip(invCustlip) {
    return this.http.post(`${this.baseApiUrl}/InvCustlips`, invCustlip);
  }
  updateInvCustlip(id, invCustlip) {
    return this.http.put(`${this.baseApiUrl}/InvCustlips/${id}`, invCustlip);
  }
  deleteInvCustlip(id) {
    return this.http.delete(`${this.baseApiUrl}/InvCustlips/${id}`);
  }
  // Colors and Brands methods
  getColors() {
    return this.http.get(`${this.baseApiUrl}/colors`).pipe(tap((data) => console.log("\u2705 getColors API Response:", data)));
  }
  createColor(body) {
    return this.http.post(`${this.baseApiUrl}/colors`, body);
  }
  updateColor(id, body) {
    return this.http.patch(`${this.baseApiUrl}/colors/${id}`, body);
  }
  deleteColor(id) {
    return this.http.delete(`${this.baseApiUrl}/colors/${id}`);
  }
  getBrands() {
    return this.http.get(`${this.baseApiUrl}/brands`).pipe(tap((data) => console.log("\u2705 getBrands API Response:", data)));
  }
  createBrand(body) {
    return this.http.post(`${this.baseApiUrl}/brands`, body);
  }
  updateBrand(id, body) {
    return this.http.patch(`${this.baseApiUrl}/brands/${id}`, body);
  }
  deleteBrand(id) {
    return this.http.delete(`${this.baseApiUrl}/brands/${id}`);
  }
  // Laboratory methods
  getLaboratories() {
    return this.http.get(`${this.baseApiUrl}/laboratories`).pipe(tap((data) => console.log("\u2705 getLaboratories API Response:", data)));
  }
  // Maintenance Request methods
  getMaintenanceRequests() {
    return this.http.get(`${this.baseApiUrl}/MaintenanceRequests`);
  }
  getMaintenanceRequest(id) {
    return this.http.get(`${this.baseApiUrl}/MaintenanceRequests/${id}`);
  }
  createMaintenanceRequest(maintenanceRequest) {
    return this.http.post(`${this.baseApiUrl}/MaintenanceRequests`, maintenanceRequest);
  }
  updateMaintenanceRequest(id, maintenanceRequest) {
    return this.http.put(`${this.baseApiUrl}/MaintenanceRequests/${id}`, maintenanceRequest);
  }
  deleteMaintenanceRequest(id) {
    return this.http.delete(`${this.baseApiUrl}/MaintenanceRequests/${id}`);
  }
  // ICS Data methods
  getAssetInventoryCustodianSlip(assetId) {
    return this.http.get(`${this.baseApiUrl}/assets/${assetId}/inventoryCustodianSlip`).pipe(tap((data) => console.log("\u2705 ICS API Response:", data)));
  }
  // QR Code upload method
  uploadQrCode(assetId, file) {
    const formData = new FormData();
    formData.append("file", file);
    return this.http.post(`${this.baseApiUrl}/storage/qr-code/${assetId}`, formData).pipe(tap((response) => console.log("\u2705 QR Code upload successful:", response)));
  }
  // User methods
  getUsers() {
  ...
  static \u0275fac = function AssetService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AssetService)(\u0275\u0275inject(HttpClient));
  };
...
// src/app/pages/service/maintenance.service.ts
var MaintenanceService = class _MaintenanceService {
  ...
  createServiceMaintenance(body) {
    return this.http.post(`${this.baseApiUrl}/service-maintenance`, body);
  }
  updateServiceMaintenance(id, body) {
    return this.http.put(`${this.baseApiUrl}/service-maintenance/${id}`, body);
  }
  deleteServiceMaintenance(id) {
    return this.http.delete(`${this.baseApiUrl}/service-maintenance/${id}`);
  }
  getRequestStatuses() {
    const url = `${this.baseApiUrl}/request-status`;
    return this.http.get(url).pipe(tap());
  }
  createRequestStatus(body) {
    return this.http.post(`${this.baseApiUrl}/request-status`, body);
  }
  updateRequestStatus(id, body) {
    return this.http.put(`${this.baseApiUrl}/request-status/${id}`, body);
  }
  deleteRequestStatus(id) {
    return this.http.delete(`${this.baseApiUrl}/request-status/${id}`);
  }
  getPriorityLevels() {
    const url = `${this.baseApiUrl}/priority-levels`;
    return this.http.get(url).pipe(tap());
  }
  createPriorityLevel(body) {
    return this.http.post(`${this.baseApiUrl}/priority-level`, body);
  }
  updatePriorityLevel(id, body) {
    return this.http.put(`${this.baseApiUrl}/priority-level/${id}`, body);
  }
  deletePriorityLevel(id) {
    return this.http.delete(`${this.baseApiUrl}/priority-level/${id}`);
  }
  getMaintenanceTypes() {
    const url = `${this.baseApiUrl}/maintenance-types`;
    return this.http.get(url).pipe(tap());
  }
  createMaintenanceType(body) {
    return this.http.post(`${this.baseApiUrl}/maintenance-types`, body);
  }
  updateMaintenanceType(id, body) {
    return this.http.put(`${this.baseApiUrl}/maintenance-types/${id}`, body);
  }
  deleteMaintenanceType(id) {
    return this.http.delete(`${this.baseApiUrl}/maintenance-types/${id}`);
  }
  ...
  approveMaintenanceRequest(approvalData) {
    const url = `${this.baseApiUrl}/maintenance-approvals`;
    return this.http.post(url, approvalData);
  }
  // Assign Technician to Maintenance Request
  assignTechnician(requestId, assignmentData) {
  ...
  completeMaintenanceApproval(id, completionData) {
    const url = `${this.baseApiUrl}/maintenance-approvals/${id}`;
    return this.http.patch(url, completionData);
  }
  // Get Maintenance Approval Details
  getMaintenanceApproval(id) {
    const url = `${this.baseApiUrl}/maintenance-approvals/${id}`;
    return this.http.get(url);
  }
  ...
  getMaintenanceApprovalDetails(id) {
    const url = `${this.baseApiUrl}/maintenance-approvals/${id}`;
    return this.http.get(url);
  }
  ...
  declineMaintenanceRequest(requestId, reason) {
...
var UserService = class _UserService {
   ...
   */
  getCampuses() {
    return this.http.get(`${environment.apiUrl}/campuses`);
  }
  /**
   * Get all departments
  ...
  createCampus(campusData) {
    return this.http.post(`${environment.apiUrl}/campuses`, campusData);
  }
  /**
   * Update campus
  ...
  updateCampus(campusId, campusData) {
    return this.http.patch(`${environment.apiUrl}/campuses/${campusId}`, campusData);
  }
  /**
   * Delete campus
  ...
  createDepartment(departmentData) {
    return this.http.post(`${environment.apiUrl}/departments`, departmentData);
  }
  /**
   * Update department
  ...
  updateDepartment(departmentId, departmentData) {
    return this.http.patch(`${environment.apiUrl}/departments/${departmentId}`, departmentData);
  }
  /**
   * Delete department
...
var _c0 = ["dt"];
var _c1 = () => [10, 20, 30];
var _c2 = () => ({ width: "550px", maxHeight: "80vh" });
var _c3 = () => ({ width: "380px" });
function AssetsComponent_ng_template_2_p_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 14);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_2_p_button_1_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function AssetsComponent_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275template(1, AssetsComponent_ng_template_2_p_button_1_Template, 1, 0, "p-button", 12);
    \u0275\u0275elementStart(2, "p-button", 13);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_2_Template_p_button_onClick_2_listener() {
      \u0275\u0275restoreView(_r2);
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r3.isSuperAdmin && !ctx_r3.isCampusAdmin() && !ctx_r3.isFaculty);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", !ctx_r3.selectedAssets.length);
  }
}
function AssetsComponent_ng_template_4_p_select_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-select", 21);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_4_p_select_1_Template_p_select_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.selectedCampus, $event) || (ctx_r3.selectedCampus = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("onChange", function AssetsComponent_ng_template_4_p_select_1_Template_p_select_onChange_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.selectedCampus);
    \u0275\u0275property("options", ctx_r3.campuses)("showClear", true);
  }
}
function AssetsComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275template(1, AssetsComponent_ng_template_4_p_select_1_Template, 1, 3, "p-select", 15);
    \u0275\u0275elementStart(2, "p-iconfield");
    \u0275\u0275element(3, "p-inputicon", 16);
    \u0275\u0275elementStart(4, "input", 17);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_4_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.searchValue, $event) || (ctx_r3.searchValue = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function AssetsComponent_ng_template_4_Template_input_input_4_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.filter());
    });
    ...
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_4_Template_p_button_onClick_5_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.exportToExcel());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-button", 19);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_4_Template_p_button_onClick_6_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.exportToPdf());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p-button", 20);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_4_Template_p_button_onClick_7_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.printAssets());
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.isSuperAdmin);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.searchValue);
    \u0275\u0275advance();
...
function AssetsComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "Asset ID ");
    \u0275\u0275element(5, "p-sortIcon", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th", 25);
    \u0275\u0275text(7, "Asset Name ");
    \u0275\u0275element(8, "p-sortIcon", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "th", 27);
    \u0275\u0275text(10, "Property Number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(20, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "th", 28);
    \u0275\u0275text(22, "Warranty");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "th", 28);
    \u0275\u0275text(24, "QR");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "th", 29);
    \u0275\u0275text(26, "Actions");
    \u0275\u0275elementEnd()();
  }
}
function AssetsComponent_ng_template_9_button_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 36);
    \u0275\u0275listener("click", function AssetsComponent_ng_template_9_button_24_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const asset_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.view(asset_r8));
    });
    \u0275\u0275elementEnd();
  }
}
function AssetsComponent_ng_template_9_button_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 37);
    \u0275\u0275listener("click", function AssetsComponent_ng_template_9_button_25_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const asset_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.delete(asset_r8));
    });
    \u0275\u0275elementEnd();
  }
}
function AssetsComponent_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(18, "p-tag", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td");
    \u0275\u0275element(20, "p-tag", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "td")(22, "button", 32);
    \u0275\u0275listener("click", function AssetsComponent_ng_template_9_Template_button_click_22_listener() {
      const asset_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.viewQrCode(asset_r8.qrCode));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "td");
    \u0275\u0275template(24, AssetsComponent_ng_template_9_button_24_Template, 1, 0, "button", 33)(25, AssetsComponent_ng_template_9_button_25_Template, 1, 0, "button", 34);
    \u0275\u0275elementStart(26, "button", 35);
    \u0275\u0275listener("click", function AssetsComponent_ng_template_9_Template_button_click_26_listener() {
      const asset_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.requestMaintenance(asset_r8));
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("value", asset_r8);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r3.getShortAssetId(asset_r8.assetId));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(asset_r8.assetName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(asset_r8.propertyNumber);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((asset_r8.inventoryCustodianSlip == null ? null : asset_r8.inventoryCustodianSlip.serialNumber) || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((asset_r8.campus == null ? null : asset_r8.campus.campusName) || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((asset_r8.laboratories == null ? null : asset_r8.laboratories.laboratoryName) || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(asset_r8.issuedTo || "Not assigned");
    \u0275\u0275advance(2);
    \u0275\u0275property("value", (asset_r8.status == null ? null : asset_r8.status.statusName) || "Unknown")("severity", ctx_r3.getStatusSeverity(asset_r8.status == null ? null : asset_r8.status.statusName));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", asset_r8.warranty ? "Active" : "Expired")("severity", asset_r8.warranty ? "success" : "danger");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", ctx_r3.isCampusAdmin() || ctx_r3.isFaculty || ctx_r3.isLabTech);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r3.isFaculty);
  }
}
function AssetsComponent_ng_template_11_div_15_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.getFullName(option_r12));
  }
}
function AssetsComponent_ng_template_11_div_15_ng_template_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(program_r13.programName);
  }
}
function AssetsComponent_ng_template_11_div_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 43)(1, "div", 44)(2, "div")(3, "label", 45);
    \u0275\u0275text(4, "Asset Name *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "input", 46);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.assetName, $event) || (ctx_r3.newAsset.assetName = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div")(7, "label", 45);
    \u0275\u0275text(8, "Property Number *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "input", 47);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.propertyNumber, $event) || (ctx_r3.newAsset.propertyNumber = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div")(11, "label", 45);
    \u0275\u0275text(12, "Category *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "p-select", 48);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_p_select_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.category, $event) || (ctx_r3.newAsset.category = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("onChange", function AssetsComponent_ng_template_11_div_15_Template_p_select_onChange_13_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onCategoryChange());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div")(15, "label", 45);
    \u0275\u0275text(16, "Found Cluster");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "input", 49);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_input_ngModelChange_17_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.foundCluster, $event) || (ctx_r3.newAsset.foundCluster = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 50)(19, "label", 45);
    \u0275\u0275text(20, "Purpose");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "textarea", 51);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_textarea_ngModelChange_21_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.purpose, $event) || (ctx_r3.newAsset.purpose = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div")(23, "label", 45);
    \u0275\u0275text(24, "Issued To");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "p-autoComplete", 52);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_p_autoComplete_ngModelChange_25_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.issuedTo, $event) || (ctx_r3.newAsset.issuedTo = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_p_autoComplete_ngModelChange_25_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onIssuedToChange($event));
    })("completeMethod", function AssetsComponent_ng_template_11_div_15_Template_p_autoComplete_completeMethod_25_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.filterUsers($event));
    });
    \u0275\u0275template(26, AssetsComponent_ng_template_11_div_15_ng_template_26_Template, 2, 1, "ng-template", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div")(28, "label", 45);
    \u0275\u0275text(29, "Program");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "p-autoComplete", 54);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_p_autoComplete_ngModelChange_30_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.program, $event) || (ctx_r3.newAsset.program = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_p_autoComplete_ngModelChange_30_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onProgramChange($event));
    })("completeMethod", function AssetsComponent_ng_template_11_div_15_Template_p_autoComplete_completeMethod_30_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.filterPrograms($event));
    });
    \u0275\u0275template(31, AssetsComponent_ng_template_11_div_15_ng_template_31_Template, 2, 1, "ng-template", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div")(33, "label", 45);
    \u0275\u0275text(34, "Supplier");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "input", 55);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_input_ngModelChange_35_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.supplier, $event) || (ctx_r3.newAsset.supplier = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "div")(37, "label", 45);
    \u0275\u0275text(38, "Laboratory");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "p-select", 56);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_15_Template_p_select_ngModelChange_39_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.laboratories, $event) || (ctx_r3.newAsset.laboratories = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.assetName);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.propertyNumber);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.category);
    \u0275\u0275property("options", ctx_r3.categoryOptions);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.foundCluster);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.purpose);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.issuedTo);
    \u0275\u0275property("suggestions", ctx_r3.filteredUsers)("dropdown", true)("forceSelection", false)("showClear", true);
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.program);
    \u0275\u0275property("suggestions", ctx_r3.filteredPrograms)("dropdown", true)("forceSelection", false)("showEmptyMessage", true);
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.supplier);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.laboratories);
    \u0275\u0275property("options", ctx_r3.laboratories);
  }
}
function AssetsComponent_ng_template_11_div_16_div_63_span_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const serial_r15 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", serial_r15, " ");
  }
}
function AssetsComponent_ng_template_11_div_16_div_63_span_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ... and ", ctx_r3.serialNumbersParsed.length - 10, " more ");
  }
}
function AssetsComponent_ng_template_11_div_16_div_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 85)(1, "p", 86);
    \u0275\u0275element(2, "i", 87);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 88);
    \u0275\u0275template(5, AssetsComponent_ng_template_11_div_16_div_63_span_5_Template, 2, 1, "span", 89)(6, AssetsComponent_ng_template_11_div_16_div_63_span_6_Template, 2, 1, "span", 90);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Parsed ", ctx_r3.serialNumbersParsed.length, " serial number(s)");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r3.serialNumbersParsed.slice(0, 10));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.serialNumbersParsed.length > 10);
  }
}
function AssetsComponent_ng_template_11_div_16_div_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 93)(1, "p", 94);
    \u0275\u0275element(2, "i", 95);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r3.serialValidationError);
  }
}
function AssetsComponent_ng_template_11_div_16_div_65_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" Quantity (", ctx_r3.newAsset.inventoryCustodianSlip.quantity || 0, ") must match number of serial numbers entered (", ctx_r3.serialNumbersParsed.length, ") ");
  }
}
function AssetsComponent_ng_template_11_div_16_ng_template_78_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(brand_r16.brandName);
  }
}
function AssetsComponent_ng_template_11_div_16_ng_template_83_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(color_r17.colorName);
  }
}
function AssetsComponent_ng_template_11_div_16_div_88_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Scanned: ", ctx_r3.newAsset.qrCode.substring(0, 50), "...");
  }
}
function AssetsComponent_ng_template_11_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.icsNo, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.icsNo = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div")(7, "label", 45);
    \u0275\u0275text(8, " Quantity * ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "p-inputNumber", 58);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_inputNumber_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.quantity, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.quantity = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("onInput", function AssetsComponent_ng_template_11_div_16_Template_p_inputNumber_onInput_9_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.validateSerialNumbers());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "p", 59);
    \u0275\u0275element(11, "i", 60);
    \u0275\u0275text(12, " Must match the number of serial numbers entered below");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div")(14, "label", 45);
    \u0275\u0275text(15, "Unit of Measure *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "input", 61);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_input_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.uoM, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.uoM = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(19, "Unit Cost");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "p-inputNumber", 62);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_inputNumber_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.unitCost, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.unitCost = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 50)(22, "label", 45);
    \u0275\u0275text(23, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "textarea", 63);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_textarea_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.description, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.description = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 50)(26, "label", 45);
    \u0275\u0275text(27, "Specifications");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "textarea", 64);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_textarea_ngModelChange_28_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.specifications, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.specifications = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div")(30, "label", 45);
    \u0275\u0275text(31, "Height");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "p-inputNumber", 65);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_inputNumber_ngModelChange_32_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.height, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.height = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div")(34, "label", 45);
    \u0275\u0275text(35, "Width");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "p-inputNumber", 66);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_inputNumber_ngModelChange_36_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.width, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.width = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(39, "Length");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "p-inputNumber", 67);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_inputNumber_ngModelChange_40_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.length, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.length = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "div")(42, "label", 45);
    \u0275\u0275text(43, "Package");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "input", 68);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_input_ngModelChange_44_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.package, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.package = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div")(46, "label", 45);
    \u0275\u0275text(47, "Material");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "input", 69);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_input_ngModelChange_48_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.material, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.material = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "div", 50)(50, "label", 45);
    \u0275\u0275text(51, " Serial Number(s) * ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "div", 70);
    \u0275\u0275element(53, "i", 71);
    \u0275\u0275elementStart(54, "div", 72)(55, "p", 73);
    \u0275\u0275text(56, "Bulk Asset Creation");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "p", 74);
    \u0275\u0275text(58, " Enter serial numbers (one per line, or separated by comma/semicolon). ");
    \u0275\u0275elementStart(59, "strong");
    \u0275\u0275text(60, "Each serial number creates a separate asset record");
    \u0275\u0275elementEnd();
    \u0275\u0275text(61, " in the database. Count must match Quantity field. ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(62, "textarea", 75);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_textarea_ngModelChange_62_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.serialNumbersRaw, $event) || (ctx_r3.serialNumbersRaw = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_textarea_ngModelChange_62_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.validateSerialNumbers());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(63, AssetsComponent_ng_template_11_div_16_div_63_Template, 7, 3, "div", 76)(64, AssetsComponent_ng_template_11_div_16_div_64_Template, 4, 1, "div", 77)(65, AssetsComponent_ng_template_11_div_16_div_65_Template, 4, 2, "div", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "div")(67, "label", 45);
    \u0275\u0275text(68, "Model Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "input", 79);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_input_ngModelChange_69_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.modelNumber, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.modelNumber = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(70, "div")(71, "label", 45);
    \u0275\u0275text(72, "Estimated Useful Life");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "input", 80);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_input_ngModelChange_73_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.estimatedUsefullLife, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.estimatedUsefullLife = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(74, "div")(75, "label", 45);
    \u0275\u0275text(76, "Brand");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "p-autoComplete", 81);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_autoComplete_ngModelChange_77_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.brand, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.brand = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_autoComplete_ngModelChange_77_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onBrandChange($event));
    })("completeMethod", function AssetsComponent_ng_template_11_div_16_Template_p_autoComplete_completeMethod_77_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.filterBrands($event));
    });
    \u0275\u0275template(78, AssetsComponent_ng_template_11_div_16_ng_template_78_Template, 2, 1, "ng-template", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(79, "div")(80, "label", 45);
    \u0275\u0275text(81, "Color");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(82, "p-autoComplete", 82);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_autoComplete_ngModelChange_82_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.newAsset.inventoryCustodianSlip.color, $event) || (ctx_r3.newAsset.inventoryCustodianSlip.color = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function AssetsComponent_ng_template_11_div_16_Template_p_autoComplete_ngModelChange_82_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onColorChange($event));
    })("completeMethod", function AssetsComponent_ng_template_11_div_16_Template_p_autoComplete_completeMethod_82_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.filterColors($event));
    });
    \u0275\u0275template(83, AssetsComponent_ng_template_11_div_16_ng_template_83_Template, 2, 1, "ng-template", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(84, "div", 50)(85, "label", 45);
    \u0275\u0275text(86, "QR Code Image *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "p-fileUpload", 83);
    \u0275\u0275listener("onSelect", function AssetsComponent_ng_template_11_div_16_Template_p_fileUpload_onSelect_87_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onQRCodeSelect($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(88, AssetsComponent_ng_template_11_div_16_div_88_Template, 4, 1, "div", 84);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.icsNo);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.quantity);
    \u0275\u0275property("useGrouping", false)("min", 1)("showButtons", true);
    \u0275\u0275advance(7);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.uoM);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.unitCost);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.description);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.specifications);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.height);
    \u0275\u0275property("useGrouping", false)("disabled", ctx_r3.isSoftwareCategory());
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.width);
    \u0275\u0275property("useGrouping", false)("disabled", ctx_r3.isSoftwareCategory());
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.length);
    \u0275\u0275property("useGrouping", false)("disabled", ctx_r3.isSoftwareCategory());
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.package);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.material);
    \u0275\u0275property("disabled", ctx_r3.isSoftwareCategory());
    \u0275\u0275advance(14);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.serialNumbersRaw);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.serialNumbersParsed.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.serialValidationError);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.quantitySerialMismatch && !ctx_r3.serialValidationError);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.modelNumber);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.estimatedUsefullLife);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.brand);
    \u0275\u0275property("suggestions", ctx_r3.filteredBrands)("dropdown", true)("forceSelection", false)("showEmptyMessage", true);
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newAsset.inventoryCustodianSlip.color);
    \u0275\u0275property("suggestions", ctx_r3.filteredColors)("dropdown", true)("forceSelection", false)("showEmptyMessage", true)("disabled", ctx_r3.isSoftwareCategory());
    \u0275\u0275advance(5);
    \u0275\u0275property("auto", false)("customUpload", true)("showUploadButton", false)("showCancelButton", false);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.newAsset.qrCode);
  }
}
function AssetsComponent_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38)(1, "div")(2, "div");
    \u0275\u0275text(3, " 1 ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 39)(5, "div", 40);
    \u0275\u0275text(6, "Asset Details");
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(7, "div");
    \u0275\u0275elementStart(8, "div")(9, "div");
    \u0275\u0275text(10, " 2 ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 39)(12, "div", 40);
    \u0275\u0275text(13, "ICS Details");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(14, "div", 41);
    \u0275\u0275template(15, AssetsComponent_ng_template_11_div_15_Template, 40, 19, "div", 42)(16, AssetsComponent_ng_template_11_div_16_Template, 89, 43, "div", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275styleMap("display: flex; align-items: center; gap: 8px; " + (ctx_r3.currentStep >= 0 ? "opacity: 1;" : "opacity: 0.5;"));
    \u0275\u0275advance();
    \u0275\u0275styleMap("width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 16px; color: white; " + (ctx_r3.currentStep >= 0 ? "background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);" : "background: #d0d0d0;"));
    \u0275\u0275advance(5);
    \u0275\u0275styleMap("height: 2px; width: 40px; " + (ctx_r3.currentStep >= 1 ? "background: linear-gradient(90deg, #667eea 0%, #764ba2 100%);" : "background: #d0d0d0;"));
    \u0275\u0275advance();
    \u0275\u0275styleMap("display: flex; align-items: center; gap: 8px; " + (ctx_r3.currentStep >= 1 ? "opacity: 1;" : "opacity: 0.5;"));
    \u0275\u0275advance();
    \u0275\u0275styleMap("width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 16px; color: white; " + (ctx_r3.currentStep >= 1 ? "background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);" : "background: #d0d0d0;"));
    \u0275\u0275advance(5);
    \u0275\u0275property("ngSwitch", ctx_r3.currentStep);
    \u0275\u0275advance();
...
function AssetsComponent_ng_template_13_p_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 107);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_13_p_button_3_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r3 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("disabled", ctx_r3.isSubmitting);
  }
}
function AssetsComponent_ng_template_13_p_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 108);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_13_p_button_4_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r3 = \u0275\u0275nextContext(2);
...
function AssetsComponent_ng_template_13_p_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 109);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_13_p_button_5_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r20);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.saveNewAsset());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("label", ctx_r3.isSubmitting ? "Saving..." : "Save Asset")("icon", ctx_r3.isSubmitting ? "pi pi-spin pi-spinner" : "pi pi-check")("disabled", ctx_r3.isSubmitting)("loading", ctx_r3.isSubmitting);
  }
}
function AssetsComponent_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 102);
    \u0275\u0275element(1, "div");
    \u0275\u0275elementStart(2, "div", 103);
    \u0275\u0275template(3, AssetsComponent_ng_template_13_p_button_3_Template, 1, 1, "p-button", 104)(4, AssetsComponent_ng_template_13_p_button_4_Template, 1, 1, "p-button", 105)(5, AssetsComponent_ng_template_13_p_button_5_Template, 1, 4, "p-button", 106);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r3.currentStep > 0);
    \u0275\u0275advance();
...
function AssetsComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 110)(1, "div", 111)(2, "label", 112);
    \u0275\u0275text(3, "Asset");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "input", 113);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_16_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r21);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.maintenanceRequest.maintenanceName, $event) || (ctx_r3.maintenanceRequest.maintenanceName = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 114)(6, "label", 112);
    \u0275\u0275text(7, "Type *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p-select", 115);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_16_Template_p_select_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r21);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.maintenanceRequest.maintenanceType, $event) || (ctx_r3.maintenanceRequest.maintenanceType = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 114)(10, "label", 112);
    \u0275\u0275text(11, "Service *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "p-select", 115);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_16_Template_p_select_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r21);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.maintenanceRequest.serviceMaintenance, $event) || (ctx_r3.maintenanceRequest.serviceMaintenance = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 114)(14, "label", 112);
    \u0275\u0275text(15, "Asset ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "input", 113);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_16_Template_input_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r21);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.maintenanceRequest.asset, $event) || (ctx_r3.maintenanceRequest.asset = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 114)(18, "label", 112);
    \u0275\u0275text(19, "Priority *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "p-select", 115);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_16_Template_p_select_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r21);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.maintenanceRequest.priorityLevel, $event) || (ctx_r3.maintenanceRequest.priorityLevel = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 111)(22, "label", 112);
    \u0275\u0275text(23, "Reason *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "textarea", 116);
    \u0275\u0275twoWayListener("ngModelChange", function AssetsComponent_ng_template_16_Template_textarea_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r21);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.maintenanceRequest.reason, $event) || (ctx_r3.maintenanceRequest.reason = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.maintenanceRequest.maintenanceName);
    \u0275\u0275property("disabled", true);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.maintenanceRequest.maintenanceType);
    \u0275\u0275property("options", ctx_r3.maintenanceTypesOptions);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.maintenanceRequest.serviceMaintenance);
    \u0275\u0275property("options", ctx_r3.serviceMaintenancesOptions);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.maintenanceRequest.asset);
    \u0275\u0275property("disabled", true);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.maintenanceRequest.priorityLevel);
    \u0275\u0275property("options", ctx_r3.priorityLevelsOptions);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.maintenanceRequest.reason);
  }
}
function AssetsComponent_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r22 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 117)(1, "p-button", 118);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_18_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r22);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.closeRequestDialog());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "p-button", 119);
    \u0275\u0275listener("onClick", function AssetsComponent_ng_template_18_Template_p_button_onClick_2_listener() {
      \u0275\u0275restoreView(_r22);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.submitMaintenanceRequest());
    });
    \u0275\u0275elementEnd()();
  }
}
var AssetsComponent = class _AssetsComponent {
  assetService;
  messageService;
  maintenanceService;
  authService;
  ...
  assetDialog = false;
  currentStep = 0;
  newAsset = this.getEmptyAsset();
  // Serial numbers management
  serialNumbersRaw = "";
  // Raw textarea input
  serialNumbersParsed = [];
  // Parsed and validated serials
  serialValidationError = "";
  // Validation error message
  quantitySerialMismatch = false;
  // Quantity vs serial count mismatch
  isSubmitting = false;
  ...
  filteredBrands = [];
  filteredColors = [];
  constructor(assetService, messageService, maintenanceService, authService, userService, router, qrCodeService, assetExportService, assetFormService) {
    ...
    this.assetFormService = assetFormService;
  }
  getEmptyAsset() {
    return __spreadValues({}, AssetConstants.DEFAULT_EMPTY_ASSET);
  }
  ngOnInit() {
    this.checkUserRole();
  ...
  loadReferenceData() {
    console.log("\u{1F504} Starting to load reference data...");
    forkJoin({
  ...
  loadMaintenanceDialogOptions() {
    this.maintenanceService.getMaintenanceTypes().subscribe({
      next: (types) => {
        this.maintenanceTypesOptions = (types || []).map((t) => ({ label: t.maintenanceTypeName, value: t.maintenanceTypeId }));
      }
    });
    this.maintenanceService.getServiceMaintenances().subscribe({
      next: (services) => {
        this.serviceMaintenancesOptions = (services || []).map((s) => ({ label: s.serviceName, value: s.serviceMaintenanceId }));
      }
    });
    this.maintenanceService.getPriorityLevels().subscribe({
      next: (levels) => {
        this.priorityLevelsOptions = (levels || []).map((p) => ({ label: p.priorityLevelName, value: p.priorityLevelId }));
      }
    });
  }
  loadAssets() {
  ...
  isRowExpanded(assetId) {
    if (!assetId)
      return false;
    return this.expandedRowIds.has(assetId);
  }
  getIcsTableData(icsData) {
  ...
  onQRCodeSelect(event) {
    return __async(this, null, function* () {
      ...
      if (file) {
        ...
        try {
          const decodedQR = yield this.qrCodeService.decodeQrCodeFromFile(file);
          if (decodedQR) {
  ...
  ensureReferenceDataExists() {
    return __async(this, null, function* () {
      ...
      if (this.newAsset.inventoryCustodianSlip.brand && typeof this.newAsset.inventoryCustodianSlip.brand === "string") {
        ...
        console.log("\u{1F528} Creating new brand:", brandName);
        const brandPromise = this.assetService.createBrand({ brandName }).toPromise().then((createdBrand) => {
      ...
      if (this.newAsset.inventoryCustodianSlip.color && typeof this.newAsset.inventoryCustodianSlip.color === "string") {
        ...
        console.log("\u{1F528} Creating new color:", colorName);
        const colorPromise = this.assetService.createColor({ colorName }).toPromise().then((createdColor) => {
      ...
      if (this.newAsset.program && typeof this.newAsset.program === "string") {
        ...
        console.log("\u{1F528} Creating new program:", programName);
        const programPromise = this.assetService.createProgram({ programName }).toPromise().then((createdProgram) => {
      ...
      if (promises.length > 0) {
        console.log("\u{1F389} All reference data created successfully!");
      }
    });
  }
  closeDialog() {
  ...
  submitMaintenanceRequest() {
    ...
    if (!this.maintenanceRequest.maintenanceName || !this.maintenanceRequest.priorityLevel || !this.maintenanceRequest.maintenanceType || !this.maintenanceRequest.asset || !this.maintenanceRequest.serviceMaintenance || !this.maintenanceRequest.reason?.trim()) {
      this.messageService.add({ severity: "warn", summary: "Validation", detail: "All fields are required" });
      return;
    }
    const payload = __spreadValues({}, this.maintenanceRequest);
  ...
  saveNewAsset() {
    console.log("\u{1F535} Save Asset button clicked");
    if (this.isSubmitting) {
      console.warn("\u26A0\uFE0F Already submitting, ignoring duplicate click");
      return;
    }
    console.log("\u{1F4DD} Current form data:", {
    ...
    console.log(`\u{1F50D} Creating ${this.serialNumbersParsed.length} separate assets SEQUENTIALLY (one per serial number)...`);
    console.log("\u26A0\uFE0F Sequential creation prevents duplicate ICS ID race condition");
    this.ensureReferenceDataExists().then(() => {
      const assetDataCopy = JSON.parse(JSON.stringify(this.newAsset));
      ...
      this.messageService.add({
        ...
        life: 3e4
        // Show for 30 seconds or until cleared
      });
  ...
  createAssetsSequentially(index, createdAssets, qrCodeFile, assetData, serialNumbers) {
    return __async(this, null, function* () {
      ...
      if (index >= serials.length) {
        ...
        console.log(`\u{1F389} Successfully created ${createdCount} assets sequentially!`);
        this.messageService.clear();
        const assetIds = createdAssets.map((a) => a.assetId || a.id).filter(Boolean);
      ...
      try {
        ...
        console.log(`\u{1F4E6} Creating asset ${index + 1}/${serials.length}:`, {
          serialNumber,
          quantity: 1,
      ...
      console.log(`\u{1F680} Sending API request for asset ${index + 1}...`);
  ...
  showSuccessMessage(count, assetIds) {
    const idsText = assetIds.length > 0 && assetIds.length <= 5 ? `<br><small style="font-size: 12px; color: #64748b;">Asset IDs: ${assetIds.join(", ")}</small>` : assetIds.length > 5 ? `<br><small style="font-size: 12px; color: #64748b;">First 5 IDs: ${assetIds.slice(0, 5).join(", ")} ...</small>` : "";
    import_sweetalert22.default.fire({
      icon: "success",
      title: "Success!",
  ...
  closeAndRefresh() {
    console.log("\u{1F504} Closing dialog and refreshing asset list...");
    this.assetDialog = false;
    this.resetFormAndRefresh();
  }
  view(item) {
    ...
    this.assetService.getAsset(item.assetId).subscribe({
      next: (fullAsset) => {
          ...
          icsHtml = `
                        ...
                        <div class="accordion-section">
                            <div class="accordion-header" onclick="this.classList.toggle('active'); this.nextElementSibling.classList.toggle('active'); this.querySelector('.accordion-icon').classList.toggle('active');">
                                <span>\u{1F4CB} Inventory Custodian Slip (ICS) Details</span>
        ...
        if (maintenanceHistory.length > 0) {
          maintenanceHtml = `
                        ...
                        <div class="accordion-section">
                            <div class="accordion-header" onclick="this.classList.toggle('active'); this.nextElementSibling.classList.toggle('active'); this.querySelector('.accordion-icon').classList.toggle('active');">
                                <span>\u{1F527} Maintenance History (${maintenanceHistory.length})</span>
                                <span class="accordion-icon">\u25BC</span>
                            </div>
                            <div class="accordion-content">
                                <table style="width: 100%; border-collapse: collapse;">
          ...
          maintenanceHtml = `
                        ...
                        <div class="accordion-section">
                            <div class="accordion-header" onclick="this.classList.toggle('active'); this.nextElementSibling.classList.toggle('active'); this.querySelector('.accordion-icon').classList.toggle('active');">
                                <span>\u{1F527} Maintenance History</span>
                                <span class="accordion-icon">\u25BC</span>
                            </div>
                            <div class="accordion-content">
        ...
        const html = `
                    ...
                    <div style="text-align: left; max-height: 70vh; overflow-y: auto;">
                        ...
                        <div class="accordion-section">
                            <div class="accordion-header" onclick="this.classList.toggle('active'); this.nextElementSibling.classList.toggle('active'); this.querySelector('.accordion-icon').classList.toggle('active');">
                                <span>\u{1F4E6} Asset Details</span>
        ...
        import_sweetalert22.default.fire(__spreadValues({
          title: "Asset Details",
          html,
          width: "900px"
        }, buttons)).then((result) => {
  ...
  openEditModal(item) {
    ...
    const program = item.program?.programId || item.Program_id || "";
    const supplier = item.supplier?.supplierId || item.Supplier_id || "";
    const laboratories = item.laboratories?.laboratoryId || item.Laboratory_id || "";
    const ics = item.inventoryCustodianSlip || {};
    ...
    console.log("\u{1F50D} Edit Asset - Dropdown Data:");
    ...
    import_sweetalert22.default.fire({
      ...
      preConfirm: () => {
        return {
          ...
          propertyNumber: document.getElementById("propertyNumber")?.value.trim() || "",
          category: document.getElementById("category")?.value.trim() || "",
          foundCluster: document.getElementById("foundCluster")?.value.trim() || "",
          purpose: document.getElementById("purpose")?.value.trim() || "",
          issuedTo: document.getElementById("issuedTo")?.value.trim() || "",
          program: document.getElementById("program")?.value.trim() || "",
          supplier: document.getElementById("supplier")?.value.trim() || "",
          laboratories: document.getElementById("laboratories")?.value.trim() || "",
          inventoryCustodianSlip: {
            ...
            estimatedUsefullLife: document.getElementById("estimatedUsefullLife")?.value.trim() || "",
      ...
      if (result.isConfirmed && result.value) {
        import_sweetalert22.default.fire({
          ...
          if (confirmResult.isConfirmed) {
            this.assetService.patchAsset(assetId, result.value).subscribe({
              next: () => {
                import_sweetalert22.default.fire({
                  icon: "success",
                  title: "Success!",
...
`;
  ...
  static \u0275fac = function AssetsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AssetsComponent)(\u0275\u0275directiveInject(AssetService), \u0275\u0275directiveInject(MessageService), \u0275\u0275directiveInject(MaintenanceService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(QrCodeService), \u0275\u0275directiveInject(AssetExportService), \u0275\u0275directiveInject(AssetFormService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetsComponent, selectors: [["app-assets"]], viewQuery: function AssetsComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c0, 5);
    }
    if (rf & 2) {
  ...
  }, features: [\u0275\u0275ProvidersFeature([MessageService, QrCodeService, AssetExportService, AssetFormService])], decls: 20, vars: 22, consts: [["start", ""], ["end", ""], ["dt", ""], ["content", ""], ["footer", ""], ["styleClass", "mb-4"], ["dataKey", "assetId", "currentPageReportTemplate", "Showing {first} to {last} of {totalRecords} assets", "styleClass", "p-datatable-compact", 3, "selectionChange", "value", "rows", "paginator", "rowsPerPageOptions", "loading", "rowHover", "selection", "showCurrentPageReport"], ["pTemplate", "header"], ["pTemplate", "body"], ["header", "Create New Asset", 3, "visibleChange", "visible", "modal", "closable", "maximizable"], ["header", "Request Maintenance", 3, "visibleChange", "onHide", "visible", "modal", "closable"], [1, "flex", "items-center", "gap-2"], ["label", "New", "icon", "pi pi-plus", "severity", "secondary", 3, "onClick", 4, "ngIf"], ["label", "Delete Selected", "icon", "pi pi-trash", "severity", "secondary", "outlined", "", 3, "onClick", "disabled"], ["label", "New", "icon", "pi pi-plus", "severity", "secondary", 3, "onClick"], ["optionLabel", "campusName", "optionValue", "campusId", "placeholder", "Filter by Campus", "class", "w-64", "appendTo", "body", 3, "ngModel", "options", "showClear", "ngModelChange", "onChange", 4, "ngIf"], ["styleClass", "pi pi-search"], ["pInputText", "", "type", "text", "placeholder", "Search assets...", 3, "ngModelChange", "input", "ngModel"], ["icon", "pi pi-file-excel", "severity", "success", "pTooltip", "Export to Excel", 3, "onClick", "rounded", "text"], ["icon", "pi pi-file-pdf", "severity", "danger", "pTooltip", "Export to PDF", 3, "onClick", "rounded", "text"], ["icon", "pi pi-print", "severity", "info", "pTooltip", "Print", 3, "onClick", "rounded", "text"], ["optionLabel", "campusName", "optionValue", "campusId", "placeholder", "Filter by Campus", "appendTo", "body", 1, "w-64", 3, "ngModelChange", "onChange", "ngModel", "options", "showClear"], [2, "width", "3rem"], ["pSortableColumn", "assetId", 2, "width", "7rem"], ["field", "assetId"], ["pSortableColumn", "assetName", 2, "width", "8rem"], ["field", "assetName"], [2, "width", "7rem"], [2, "width", "5rem"], [2, "width", "8rem"], [3, "value"], [3, "value", "severity"], ["pButton", "", "icon", "pi pi-qrcode", "pTooltip", "View QR Code", 1, "p-button-rounded", "p-button-text", 3, "click"], ["pButton", "", "icon", "pi pi-eye", "class", "p-button-rounded p-button-text p-button-success", "pTooltip", "View Asset", 3, "click", 4, "ngIf"], ["pButton", "", "icon", "pi pi-trash", "class", "p-button-rounded p-button-text p-button-danger", "pTooltip", "Delete", 3, "click", 4, "ngIf"], ["pButton", "", "icon", "pi pi-wrench", "pTooltip", "Request Maintenance", 1, "p-button-rounded", "p-button-text", "p-button-info", 3, "click"], ["pButton", "", "icon", "pi pi-eye", "pTooltip", "View Asset", 1, "p-button-rounded", "p-button-text", "p-button-success", 3, "click"], ["pButton", "", "icon", "pi pi-trash", "pTooltip", "Delete", 1, "p-button-rounded", "p-button-text", "p-button-danger", 3, "click"], [2, "display", "flex", "justify-content", "center", "align-items", "center", "margin-bottom", "24px", "gap", "12px", "padding-bottom", "20px", "border-bottom", "1px solid #e5e5e5"], [2, "line-height", "1.2"], [2, "font-weight", "600", "color", "#1a1a1a", "font-size", "13px"], [3, "ngSwitch"], ["class", "step-content", 4, "ngSwitchCase"], [1, "step-content"], [2, "display", "grid", "grid-template-columns", "repeat(2, 1fr)", "gap", "20px"], [2, "display", "block", "font-weight", "600", "margin-bottom", "8px", "color", "#1a1a1a", "font-size", "13px"], ["pInputText", "", "placeholder", "Enter asset name", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], ["pInputText", "", "placeholder", "Enter property number", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], ["placeholder", "Select category", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "onChange", "ngModel", "options"], ["pInputText", "", "placeholder", "Enter found cluster", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], [2, "grid-column", "1 / -1"], ["pTextarea", "", "placeholder", "Enter purpose", "rows", "3", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", "font-family", "inherit", 3, "ngModelChange", "ngModel"], ["placeholder", "Search user", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "completeMethod", "ngModel", "suggestions", "dropdown", "forceSelection", "showClear"], ["pTemplate", "item"], ["dataKey", "programId", "optionLabel", "programName", "placeholder", "Search existing or type new program", "emptyMessage", "No matches found. Type to add custom program.", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "completeMethod", "ngModel", "suggestions", "dropdown", "forceSelection", "showEmptyMessage"], ["pInputText", "", "placeholder", "Enter supplier name", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], ["optionLabel", "laboratoryName", "optionValue", "laboratoryId", "placeholder", "Select laboratory", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "ngModel", "options"], ["pInputText", "", "placeholder", "ICS number", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], ["placeholder", "Enter quantity (must match serial numbers)", 1, "w-full", 3, "ngModelChange", "onInput", "ngModel", "useGrouping", "min", "showButtons"], [2, "margin", "4px 0 0 0", "font-size", "11px", "color", "#64748b"], [1, "pi", "pi-info-circle"], ["pInputText", "", "placeholder", "UoM (e.g., pcs, set)", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], ["mode", "currency", "currency", "PHP", "placeholder", "Unit cost", 1, "w-full", 3, "ngModelChange", "ngModel"], ["pTextarea", "", "placeholder", "Description", "rows", "2", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", "font-family", "inherit", 3, "ngModelChange", "ngModel"], ["pTextarea", "", "placeholder", "Specifications", "rows", "2", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", "font-family", "inherit", 3, "ngModelChange", "ngModel"], ["placeholder", "Height", 1, "w-full", 3, "ngModelChange", "ngModel", "useGrouping", "disabled"], ["placeholder", "Width", 1, "w-full", 3, "ngModelChange", "ngModel", "useGrouping", "disabled"], ["placeholder", "Length", 1, "w-full", 3, "ngModelChange", "ngModel", "useGrouping", "disabled"], ["pInputText", "", "placeholder", "Package", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], ["pInputText", "", "placeholder", "Material", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel", "disabled"], [2, "background", "#eff6ff", "border", "1px solid #bfdbfe", "border-radius", "6px", "padding", "10px 12px", "margin-bottom", "12px", "display", "flex", "gap", "10px", "align-items", "start"], [1, "pi", "pi-info-circle", 2, "color", "#3b82f6", "font-size", "16px", "margin-top", "2px"], [2, "flex", "1"], [2, "margin", "0", "font-size", "12px", "color", "#1e40af", "font-weight", "600", "margin-bottom", "4px"], [2, "margin", "0", "font-size", "11px", "color", "#1e3a8a", "line-height", "1.4"], ["pInputTextarea", "", "placeholder", "Enter serial numbers (one per line or separated by comma/semicolon)\nExample:\nSN-2026-001\nLTP-A01, LTP-A02\nDEV-X9; DEV-X10", "rows", "6", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "font-family", "'Courier New', monospace", "background", "#fafafa", "resize", "vertical", 3, "ngModelChange", "ngModel"], ["style", "margin-top: 8px; background: #f0fdf4; border: 1px solid #86efac; border-radius: 6px; padding: 10px 12px;", 4, "ngIf"], ["style", "margin-top: 8px; background: #fef2f2; border: 1px solid #fecaca; border-radius: 6px; padding: 10px 12px;", 4, "ngIf"], ["style", "margin-top: 8px; background: #fff7ed; border: 1px solid #fed7aa; border-radius: 6px; padding: 10px 12px;", 4, "ngIf"], ["pInputText", "", "placeholder", "Model number", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], ["pInputText", "", "placeholder", "e.g., 5 years", 2, "width", "100%", "padding", "11px 12px", "border", "1px solid #e0e0e0", "border-radius", "6px", "font-size", "13px", "background", "#fafafa", "transition", "all 0.3s", 3, "ngModelChange", "ngModel"], ["dataKey", "brandId", "optionLabel", "brandName", "placeholder", "Search existing or type new brand", "emptyMessage", "No matches found. Type to add custom brand.", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "completeMethod", "ngModel", "suggestions", "dropdown", "forceSelection", "showEmptyMessage"], ["dataKey", "colorId", "optionLabel", "colorName", "placeholder", "Search existing or type new color", "emptyMessage", "No matches found. Type to add custom color.", "appendTo", "body", 1, "w-full", 3, "ngModelChange", "completeMethod", "ngModel", "suggestions", "dropdown", "forceSelection", "showEmptyMessage", "disabled"], ["name", "qrCodeImage", "accept", "image/*", "maxFileSize", "5000000", "chooseLabel", "Upload QR Code Image", 3, "onSelect", "auto", "customUpload", "showUploadButton", "showCancelButton"], ["class", "mt-3 flex items-center gap-2", 4, "ngIf"], [2, "margin-top", "8px", "background", "#f0fdf4", "border", "1px solid #86efac", "border-radius", "6px", "padding", "10px 12px"], [2, "margin", "0 0 6px 0", "font-size", "12px", "font-weight", "600", "color", "#15803d"], [1, "pi", "pi-check-circle"], [2, "display", "flex", "flex-wrap", "wrap", "gap", "6px"], ["style", "display: inline-block; background: white; padding: 4px 8px; border-radius: 4px; border: 1px solid #86efac; font-size: 11px; color: #15803d; font-family: 'Courier New', monospace;", 4, "ngFor", "ngForOf"], ["style", "color: #15803d; font-size: 11px; padding: 4px 8px;", 4, "ngIf"], [2, "display", "inline-block", "background", "white", "padding", "4px 8px", "border-radius", "4px", "border", "1px solid #86efac", "font-size", "11px", "color", "#15803d", "font-family", "'Courier New', monospace"], [2, "color", "#15803d", "font-size", "11px", "padding", "4px 8px"], [2, "margin-top", "8px", "background", "#fef2f2", "border", "1px solid #fecaca", "border-radius", "6px", "padding", "10px 12px"], [2, "margin", "0", "font-size", "12px", "color", "#dc2626", "font-weight", "500"], [1, "pi", "pi-exclamation-circle"], [2, "margin-top", "8px", "background", "#fff7ed", "border", "1px solid #fed7aa", "border-radius", "6px", "padding", "10px 12px"], [2, "margin", "0", "font-size", "12px", "color", "#ea580c", "font-weight", "500"], [1, "pi", "pi-exclamation-triangle"], [1, "mt-3", "flex", "items-center", "gap-2"], [1, "pi", "pi-check-circle", "text-green-600", "text-xl"], [1, "text-sm", "text-green-600"], [1, "flex", "justify-between", "w-full"], [1, "flex", "gap-2"], ["label", "Back", "severity", "secondary", "icon", "pi pi-arrow-left", 3, "disabled", "onClick", 4, "ngIf"], ["label", "Next", "icon", "pi pi-arrow-right", "iconPos", "right", 3, "disabled", "onClick", 4, "ngIf"], [3, "label", "icon", "disabled", "loading", "onClick", 4, "ngIf"], ["label", "Back", "severity", "secondary", "icon", "pi pi-arrow-left", 3, "onClick", "disabled"], ["label", "Next", "icon", "pi pi-arrow-right", "iconPos", "right", 3, "onClick", "disabled"], [3, "onClick", "label", "icon", "disabled", "loading"], [1, "grid", "grid-cols-12", "gap-1", 2, "font-size", "12px"], [1, "col-span-12"], [1, "text-xs", "text-gray-600"], ["pInputText", "", 1, "w-full", "p-inputtext-sm", 2, "padding", "6px 8px", 3, "ngModelChange", "ngModel", "disabled"], [1, "col-span-6"], ["optionLabel", "label", "optionValue", "value", "placeholder", "Select", "appendTo", "body", 1, "w-full", "p-select-sm", 3, "ngModelChange", "ngModel", "options"], ["pInputTextarea", "", "rows", "2", "placeholder", "Describe the reason...", 1, "w-full", 2, "font-size", "12px", "padding", "6px 8px", 3, "ngModelChange", "ngModel"], [1, "flex", "justify-end", "gap-1"], ["label", "Cancel", "severity", "secondary", "text", "", "size", "small", 3, "onClick"], ["label", "Submit", "size", "small", 3, "onClick"]], template: function AssetsComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275element(0, "p-toast");
      \u0275\u0275elementStart(1, "p-toolbar", 5);
      \u0275\u0275template(2, AssetsComponent_ng_template_2_Template, 3, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(4, AssetsComponent_ng_template_4_Template, 8, 8, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "p-table", 6, 2);
      \u0275\u0275twoWayListener("selectionChange", function AssetsComponent_Template_p_table_selectionChange_6_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.selectedAssets, $event) || (ctx.selectedAssets = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("selectionChange", function AssetsComponent_Template_p_table_selectionChange_6_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSelectionChange($event));
      });
      \u0275\u0275template(8, AssetsComponent_ng_template_8_Template, 27, 0, "ng-template", 7)(9, AssetsComponent_ng_template_9_Template, 27, 14, "ng-template", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "p-dialog", 9);
      \u0275\u0275twoWayListener("visibleChange", function AssetsComponent_Template_p_dialog_visibleChange_10_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.assetDialog, $event) || (ctx.assetDialog = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275template(11, AssetsComponent_ng_template_11_Template, 17, 13, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(13, AssetsComponent_ng_template_13_Template, 6, 3, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "p-dialog", 10);
      \u0275\u0275twoWayListener("visibleChange", function AssetsComponent_Template_p_dialog_visibleChange_15_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.requestDialog, $event) || (ctx.requestDialog = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("onHide", function AssetsComponent_Template_p_dialog_onHide_15_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.closeRequestDialog());
      });
      \u0275\u0275template(16, AssetsComponent_ng_template_16_Template, 25, 11, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(18, AssetsComponent_ng_template_18_Template, 3, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
      \u0275\u0275property("value", ctx.filteredAssets)("rows", 10)("paginator", true)("rowsPerPageOptions", \u0275\u0275pureFunction0(19, _c1))("loading", ctx.loading)("rowHover", true);
      \u0275\u0275twoWayProperty("selection", ctx.selectedAssets);
      \u0275\u0275property("showCurrentPageReport", true);
      \u0275\u0275advance(4);
      \u0275\u0275styleMap(\u0275\u0275pureFunction0(20, _c2));
      \u0275\u0275twoWayProperty("visible", ctx.assetDialog);
      \u0275\u0275property("modal", true)("closable", true)("maximizable", true);
      \u0275\u0275advance(5);
      \u0275\u0275styleMap(\u0275\u0275pureFunction0(21, _c3));
      \u0275\u0275twoWayProperty("visible", ctx.requestDialog);
    ...
    FileUpload,
    StepperModule
  ], styles: ["\n\n[_nghost-%COMP%]     .expand-btn {\n  transition: transform 0.3s ease-in-out;\n}\n[_nghost-%COMP%]     .expand-btn.expanded {\n  transform: rotate(90deg);\n}\n[_nghost-%COMP%]     .expansion-row {\n  animation: _ngcontent-%COMP%_slideDown 0.3s ease-out;\n}\n[_nghost-%COMP%]     .expansion-content {\n  animation: _ngcontent-%COMP%_fadeIn 0.3s ease-out;\n}\n@keyframes _ngcontent-%COMP%_slideDown {\n  from {\n    opacity: 0;\n    transform: translateY(-10px);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n@keyframes _ngcontent-%COMP%_fadeIn {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n}\n[_nghost-%COMP%]     .animate-expand {\n  animation: _ngcontent-%COMP%_slideDown 0.3s ease-out;\n}\n[_nghost-%COMP%]     .p-datatable.p-datatable-compact {\n  font-size: 14px;\n  width: 100%;\n  max-height: calc(100vh - 200px);\n}\n[_nghost-%COMP%]     .p-datatable.p-datatable-compact .p-datatable-wrapper {\n  overflow-x: visible;\n  overflow-y: auto;\n}\n[_nghost-%COMP%]     .p-datatable.p-datatable-compact .p-datatable-thead > tr > th {\n  padding: 6px 4px;\n  font-size: 15px;\n  font-weight: 600;\n  background-color: #f3f4f6;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n[_nghost-%COMP%]     .p-datatable.p-datatable-compact .p-datatable-tbody > tr > td {\n  padding: 6px 4px;\n  font-size: 14px;\n  height: 32px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n[_nghost-%COMP%]     .p-datatable.p-datatable-compact .p-checkbox {\n  width: 18px;\n  height: 18px;\n}\n[_nghost-%COMP%]     .p-datatable.p-datatable-compact .p-button-text {\n  padding: 0.25rem 0.25rem;\n  font-size: 14px;\n}\n[_nghost-%COMP%]     .p-datatable.p-datatable-compact .p-datatable-tbody > tr:hover {\n  background-color: #eff6ff;\n}\n/*# sourceMappingURL=assets.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AssetsComponent, [{
    type: Component,
    args: [{ selector: "app-assets", standalone: true, imports: [
      CommonModule,
      TableModule,
      FormsModule,
      ButtonModule,
      ...
      FileUploadModule,
      StepperModule
    ], providers: [MessageService, QrCodeService, AssetExportService, AssetFormService], template: `
        <p-toast />
    ...
    `, styles: ["/* src/app/pages/assets/assets.component.scss */\n:host ::ng-deep .expand-btn {\n  transition: transform 0.3s ease-in-out;\n}\n:host ::ng-deep .expand-btn.expanded {\n  transform: rotate(90deg);\n}\n:host ::ng-deep .expansion-row {\n  animation: slideDown 0.3s ease-out;\n}\n:host ::ng-deep .expansion-content {\n  animation: fadeIn 0.3s ease-out;\n}\n@keyframes slideDown {\n  from {\n    opacity: 0;\n    transform: translateY(-10px);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n@keyframes fadeIn {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n}\n:host ::ng-deep .animate-expand {\n  animation: slideDown 0.3s ease-out;\n}\n:host ::ng-deep .p-datatable.p-datatable-compact {\n  font-size: 14px;\n  width: 100%;\n  max-height: calc(100vh - 200px);\n}\n:host ::ng-deep .p-datatable.p-datatable-compact .p-datatable-wrapper {\n  overflow-x: visible;\n  overflow-y: auto;\n}\n:host ::ng-deep .p-datatable.p-datatable-compact .p-datatable-thead > tr > th {\n  padding: 6px 4px;\n  font-size: 15px;\n  font-weight: 600;\n  background-color: #f3f4f6;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n:host ::ng-deep .p-datatable.p-datatable-compact .p-datatable-tbody > tr > td {\n  padding: 6px 4px;\n  font-size: 14px;\n  height: 32px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n:host ::ng-deep .p-datatable.p-datatable-compact .p-checkbox {\n  width: 18px;\n  height: 18px;\n}\n:host ::ng-deep .p-datatable.p-datatable-compact .p-button-text {\n  padding: 0.25rem 0.25rem;\n  font-size: 14px;\n}\n:host ::ng-deep .p-datatable.p-datatable-compact .p-datatable-tbody > tr:hover {\n  background-color: #eff6ff;\n}\n/*# sourceMappingURL=assets.component.css.map */\n"] }]
  }], () => [{ type: AssetService }, { type: MessageService }, { type: MaintenanceService }, { type: AuthService }, { type: UserService }, { type: Router }, { type: QrCodeService }, { type: AssetExportService }, { type: AssetFormService }], { dt: [{
    type: ViewChild,
    args: ["dt"]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetsComponent, { className: "AssetsComponent", filePath: "src/app/pages/assets/assets.ts", lineNumber: 578 });
})();

// src/app/pages/requestmaintenance/requestmaintenance/requestmaintenance.component.ts
var import_sweetalert23 = __toESM(require_sweetalert2_all());
function RequestmaintenanceComponent_ng_template_3_p_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 25);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_ng_template_3_p_button_1_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r2);
...
function RequestmaintenanceComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275template(1, RequestmaintenanceComponent_ng_template_3_p_button_1_Template, 1, 1, "p-button", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.isLabTech());
  }
}
function RequestmaintenanceComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 23)(1, "p-button", 26);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_ng_template_5_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "p-iconfield");
    \u0275\u0275element(3, "p-inputicon", 27);
    \u0275\u0275elementStart(4, "input", 28);
    \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_ng_template_5_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.searchValue, $event) || (ctx_r2.searchValue = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function RequestmaintenanceComponent_ng_template_5_Template_input_input_4_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.filterByTab());
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function RequestmaintenanceComponent_div_18_table_1_th_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1, "Actions");
    \u0275\u0275elementEnd();
...
function RequestmaintenanceComponent_div_18_table_1_tr_23_td_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td")(1, "div", 38)(2, "p-button", 39);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_18_table_1_tr_23_td_22_Template_p_button_onClick_2_listener() {
      \u0275\u0275restoreView(_r8);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p-button", 40);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_18_table_1_tr_23_td_22_Template_p_button_onClick_3_listener() {
      \u0275\u0275restoreView(_r8);
      const row_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.decline(row_r7));
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function RequestmaintenanceComponent_div_18_table_1_tr_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "input", 34);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_18_table_1_tr_23_Template_input_change_2_listener() {
      const row_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleSelect(row_r7));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275text(4);
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td")(12, "span", 36);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td")(20, "span", 37);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(22, RequestmaintenanceComponent_div_18_table_1_tr_23_td_22_Template, 4, 4, "td", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275property("checked", ctx_r2.isSelected(row_r7));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatId(row_r7.requestId));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(row_r7.maintenanceName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((row_r7.maintenanceType == null ? null : row_r7.maintenanceType.maintenanceTypeName) || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((row_r7.serviceMaintenance == null ? null : row_r7.serviceMaintenance.serviceName) || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", "tag-" + ctx_r2.getPriorityClass(row_r7.priorityLevel == null ? null : row_r7.priorityLevel.priorityLevelName));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (row_r7.priorityLevel == null ? null : row_r7.priorityLevel.priorityLevelName) || "N/A", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(16, 11, row_r7.requestDate || row_r7.createdAt, "short"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.getFullName(row_r7));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(row_r7.maintenanceStatus == null ? null : row_r7.maintenanceStatus.requestStatusName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.isCampusAdmin());
  }
}
function RequestmaintenanceComponent_div_18_table_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "table")(1, "thead")(2, "tr")(3, "th", 33)(4, "input", 34);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_18_table_1_Template_input_change_4_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleSelectAll("pending"));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "Request ID");
    ...
    \u0275\u0275text(16, "Request Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "th");
    \u0275\u0275text(18, "Requested By");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "th");
    \u0275\u0275text(20, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275template(21, RequestmaintenanceComponent_div_18_table_1_th_21_Template, 2, 0, "th", 30);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "tbody");
    \u0275\u0275template(23, RequestmaintenanceComponent_div_18_table_1_tr_23_Template, 23, 14, "tr", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("checked", ctx_r2.isAllSelected("pending"));
    \u0275\u0275advance(17);
    \u0275\u0275property("ngIf", ctx_r2.isCampusAdmin());
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.paginatedPendingItems);
  }
}
function RequestmaintenanceComponent_div_18_div_2_option_14_Template(rf, ctx) {
  if (rf & 1) {
...
function RequestmaintenanceComponent_div_18_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_18_div_2_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("pending", 1));
    });
    \u0275\u0275element(4, "i", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_18_div_2_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("pending", ctx_r2.pendingPage - 1));
    });
    \u0275\u0275element(6, "i", 45);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_18_div_2_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("pending", ctx_r2.pendingPage + 1));
    });
    ...
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_18_div_2_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("pending", ctx_r2.getTotalPages("pending")));
    });
    \u0275\u0275element(12, "i", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "select", 49);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_18_div_2_Template_select_change_13_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onRowsPerPageChange($event));
    });
    \u0275\u0275template(14, RequestmaintenanceComponent_div_18_div_2_option_14_Template, 2, 2, "option", 50);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3("Showing ", ctx_r2.getPageStart("pending"), " to ", ctx_r2.getPageEnd("pending"), " of ", ctx_r2.getTotalItems("pending"), " requests");
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.pendingPage === 1);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.pendingPage === 1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.pendingPage);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.pendingPage === ctx_r2.getTotalPages("pending"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.pendingPage === ctx_r2.getTotalPages("pending"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", ctx_r2.rowsPerPage);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r2.rowsPerPageOptions);
  }
}
function RequestmaintenanceComponent_div_18_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function RequestmaintenanceComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275template(1, RequestmaintenanceComponent_div_18_table_1_Template, 24, 3, "table", 30)(2, RequestmaintenanceComponent_div_18_div_2_Template, 15, 10, "div", 31)(3, RequestmaintenanceComponent_div_18_div_3_Template, 2, 0, "div", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredPendingItems.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredPendingItems.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredPendingItems.length === 0);
...
function RequestmaintenanceComponent_div_20_table_1_th_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1, "Actions");
    \u0275\u0275elementEnd();
...
function RequestmaintenanceComponent_div_20_table_1_tr_17_td_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td")(1, "div", 38)(2, "p-button", 53);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_20_table_1_tr_17_td_15_Template_p_button_onClick_2_listener() {
      \u0275\u0275restoreView(_r14);
      const row_r13 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.startMaintenanceWork(row_r13));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p-button", 54);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_20_table_1_tr_17_td_15_Template_p_button_onClick_3_listener() {
      \u0275\u0275restoreView(_r14);
      const row_r13 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.cancelMaintenance(row_r13));
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function RequestmaintenanceComponent_div_20_table_1_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "input", 34);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_20_table_1_tr_17_Template_input_change_2_listener() {
      const row_r13 = \u0275\u0275restoreView(_r12).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleSelect(row_r13));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275text(4);
    ...
    \u0275\u0275pipe(11, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td")(13, "span", 37);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(15, RequestmaintenanceComponent_div_20_table_1_tr_17_td_15_Template, 4, 4, "td", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275property("checked", ctx_r2.isSelected(row_r13));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatId(row_r13.maintenanceRequest == null ? null : row_r13.maintenanceRequest.requestId));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(row_r13.maintenanceRequest == null ? null : row_r13.maintenanceRequest.maintenanceName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", row_r13.assignedTechnician == null ? null : row_r13.assignedTechnician.firstName, " ", (row_r13.assignedTechnician == null ? null : row_r13.assignedTechnician.lastName) || "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 8, row_r13.scheduledAt, "short"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", row_r13.status || "Scheduled", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.isLabTech());
  }
}
function RequestmaintenanceComponent_div_20_table_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "table")(1, "thead")(2, "tr")(3, "th", 33)(4, "input", 34);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_20_table_1_Template_input_change_4_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleSelectAll("scheduled"));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th");
    \u0275\u0275text(8, "Maintenance Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "th");
    \u0275\u0275text(10, "Assigned Technician");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "th");
    \u0275\u0275text(12, "Scheduled Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th");
    \u0275\u0275text(14, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, RequestmaintenanceComponent_div_20_table_1_th_15_Template, 2, 0, "th", 30);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "tbody");
    \u0275\u0275template(17, RequestmaintenanceComponent_div_20_table_1_tr_17_Template, 16, 11, "tr", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("checked", ctx_r2.isAllSelected("scheduled"));
    \u0275\u0275advance(11);
    \u0275\u0275property("ngIf", ctx_r2.isLabTech());
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.paginatedScheduledItems);
  }
}
function RequestmaintenanceComponent_div_20_div_2_option_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 51);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function RequestmaintenanceComponent_div_20_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_20_div_2_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("scheduled", 1));
    });
    \u0275\u0275element(4, "i", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_20_div_2_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("scheduled", ctx_r2.scheduledPage - 1));
    });
    \u0275\u0275element(6, "i", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 46);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_20_div_2_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("scheduled", ctx_r2.scheduledPage + 1));
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_20_div_2_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("scheduled", ctx_r2.getTotalPages("scheduled")));
    });
    \u0275\u0275element(12, "i", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "select", 49);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_20_div_2_Template_select_change_13_listener($event) {
      \u0275\u0275restoreView(_r15);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onRowsPerPageChange($event));
    });
    \u0275\u0275template(14, RequestmaintenanceComponent_div_20_div_2_option_14_Template, 2, 2, "option", 50);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3("Showing ", ctx_r2.getPageStart("scheduled"), " to ", ctx_r2.getPageEnd("scheduled"), " of ", ctx_r2.getTotalItems("scheduled"), " requests");
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.scheduledPage === 1);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.scheduledPage === 1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.scheduledPage);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.scheduledPage === ctx_r2.getTotalPages("scheduled"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.scheduledPage === ctx_r2.getTotalPages("scheduled"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", ctx_r2.rowsPerPage);
...
function RequestmaintenanceComponent_div_20_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52);
    \u0275\u0275text(1, "No scheduled requests found");
    \u0275\u0275elementEnd();
  }
}
function RequestmaintenanceComponent_div_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275template(1, RequestmaintenanceComponent_div_20_table_1_Template, 18, 3, "table", 30)(2, RequestmaintenanceComponent_div_20_div_2_Template, 15, 10, "div", 31)(3, RequestmaintenanceComponent_div_20_div_3_Template, 2, 0, "div", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredScheduledItems.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredScheduledItems.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredScheduledItems.length === 0);
...
function RequestmaintenanceComponent_div_22_table_1_th_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1, "Actions");
    \u0275\u0275elementEnd();
...
function RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "p-button", 56);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_ng_container_2_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r21);
      const row_r19 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.resumeMaintenance(row_r19));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
...
function RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r22 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "p-button", 57);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_ng_container_3_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r22);
      const row_r19 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.confirm(row_r19));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "p-button", 58);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_ng_container_3_Template_p_button_onClick_2_listener() {
      \u0275\u0275restoreView(_r22);
      const row_r19 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.holdMaintenance(row_r19));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
...
function RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td")(1, "div", 38);
    \u0275\u0275template(2, RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_ng_container_2_Template, 2, 2, "ng-container", 30)(3, RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_ng_container_3_Template, 3, 4, "ng-container", 30);
    \u0275\u0275elementStart(4, "p-button", 54);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_Template_p_button_onClick_4_listener() {
      \u0275\u0275restoreView(_r20);
      const row_r19 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.cancelMaintenance(row_r19));
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const row_r19 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", row_r19.status === "ON_HOLD");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", row_r19.status !== "ON_HOLD");
    \u0275\u0275advance();
    \u0275\u0275property("rounded", true)("text", true);
...
function RequestmaintenanceComponent_div_22_table_1_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "input", 34);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_22_table_1_tr_17_Template_input_change_2_listener() {
      const row_r19 = \u0275\u0275restoreView(_r18).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleSelect(row_r19));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275text(4);
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(15, RequestmaintenanceComponent_div_22_table_1_tr_17_td_15_Template, 5, 4, "td", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275property("checked", ctx_r2.isSelected(row_r19));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatId(row_r19.maintenanceRequest == null ? null : row_r19.maintenanceRequest.requestId));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(row_r19.maintenanceRequest == null ? null : row_r19.maintenanceRequest.maintenanceName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", row_r19.assignedTechnician == null ? null : row_r19.assignedTechnician.firstName, " ", (row_r19.assignedTechnician == null ? null : row_r19.assignedTechnician.lastName) || "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 8, row_r19.startedAt, "short"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", row_r19.status || "In Progress", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.isLabTech());
  }
}
function RequestmaintenanceComponent_div_22_table_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "table")(1, "thead")(2, "tr")(3, "th", 33)(4, "input", 34);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_22_table_1_Template_input_change_4_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleSelectAll("inprogress"));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "ID");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "th");
    \u0275\u0275text(12, "Started At");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th");
    \u0275\u0275text(14, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, RequestmaintenanceComponent_div_22_table_1_th_15_Template, 2, 0, "th", 30);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "tbody");
    \u0275\u0275template(17, RequestmaintenanceComponent_div_22_table_1_tr_17_Template, 16, 11, "tr", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("checked", ctx_r2.isAllSelected("inprogress"));
    \u0275\u0275advance(11);
    \u0275\u0275property("ngIf", ctx_r2.isLabTech());
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.paginatedInProgressItems);
  }
}
function RequestmaintenanceComponent_div_22_div_2_option_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 51);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", opt_r24);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(opt_r24);
  }
}
function RequestmaintenanceComponent_div_22_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_22_div_2_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("inprogress", 1));
    });
    \u0275\u0275element(4, "i", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_22_div_2_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("inprogress", ctx_r2.inProgressPage - 1));
    });
    \u0275\u0275element(6, "i", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 46);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_22_div_2_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("inprogress", ctx_r2.inProgressPage + 1));
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_22_div_2_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("inprogress", ctx_r2.getTotalPages("inprogress")));
    });
    \u0275\u0275element(12, "i", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "select", 49);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_22_div_2_Template_select_change_13_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onRowsPerPageChange($event));
    });
    \u0275\u0275template(14, RequestmaintenanceComponent_div_22_div_2_option_14_Template, 2, 2, "option", 50);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3("Showing ", ctx_r2.getPageStart("inprogress"), " to ", ctx_r2.getPageEnd("inprogress"), " of ", ctx_r2.getTotalItems("inprogress"), " requests");
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.inProgressPage === 1);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.inProgressPage === 1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.inProgressPage);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.inProgressPage === ctx_r2.getTotalPages("inprogress"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.inProgressPage === ctx_r2.getTotalPages("inprogress"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", ctx_r2.rowsPerPage);
...
function RequestmaintenanceComponent_div_22_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52);
    \u0275\u0275text(1, "No in-progress requests found");
    \u0275\u0275elementEnd();
  }
}
function RequestmaintenanceComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275template(1, RequestmaintenanceComponent_div_22_table_1_Template, 18, 3, "table", 30)(2, RequestmaintenanceComponent_div_22_div_2_Template, 15, 10, "div", 31)(3, RequestmaintenanceComponent_div_22_div_3_Template, 2, 0, "div", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredInProgressItems.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredInProgressItems.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredInProgressItems.length === 0);
...
function RequestmaintenanceComponent_div_24_table_1_tr_14_p_button_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r28 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 62);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_24_table_1_tr_14_p_button_13_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r28);
      const row_r27 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.delete(row_r27));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function RequestmaintenanceComponent_div_24_table_1_tr_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r26 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "input", 34);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_24_table_1_tr_14_Template_input_change_2_listener() {
      const row_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleSelect(row_r27));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275text(4);
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td")(8, "span", 59);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "td")(11, "div", 38)(12, "p-button", 60);
    \u0275\u0275listener("onClick", function RequestmaintenanceComponent_div_24_table_1_tr_14_Template_p_button_onClick_12_listener() {
      const row_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.view(row_r27));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, RequestmaintenanceComponent_div_24_table_1_tr_14_p_button_13_Template, 1, 2, "p-button", 61);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275property("checked", ctx_r2.isSelected(row_r27));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatId(row_r27.requestId || (row_r27.maintenanceRequest == null ? null : row_r27.maintenanceRequest.requestId)));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(row_r27.maintenanceName || (row_r27.maintenanceRequest == null ? null : row_r27.maintenanceRequest.maintenanceName));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((row_r27.maintenanceStatus == null ? null : row_r27.maintenanceStatus.requestStatusName) || "Completed");
    \u0275\u0275advance(3);
    \u0275\u0275property("rounded", true)("text", true);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.isLabTech());
...
function RequestmaintenanceComponent_div_24_table_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r25 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "table")(1, "thead")(2, "tr")(3, "th", 33)(4, "input", 34);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_24_table_1_Template_input_change_4_listener() {
      \u0275\u0275restoreView(_r25);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleSelectAll("completed"));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "ID");
    ...
    \u0275\u0275template(14, RequestmaintenanceComponent_div_24_table_1_tr_14_Template, 14, 7, "tr", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("checked", ctx_r2.isAllSelected("completed"));
    \u0275\u0275advance(10);
    \u0275\u0275property("ngForOf", ctx_r2.paginatedCompletedItems);
  }
}
function RequestmaintenanceComponent_div_24_div_2_option_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 51);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function RequestmaintenanceComponent_div_24_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_24_div_2_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("completed", 1));
    });
    \u0275\u0275element(4, "i", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_24_div_2_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("completed", ctx_r2.completedPage - 1));
    });
    \u0275\u0275element(6, "i", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 46);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_24_div_2_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("completed", ctx_r2.completedPage + 1));
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "button", 43);
    \u0275\u0275listener("click", function RequestmaintenanceComponent_div_24_div_2_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.goToPage("completed", ctx_r2.getTotalPages("completed")));
    });
    \u0275\u0275element(12, "i", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "select", 49);
    \u0275\u0275listener("change", function RequestmaintenanceComponent_div_24_div_2_Template_select_change_13_listener($event) {
      \u0275\u0275restoreView(_r29);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onRowsPerPageChange($event));
    });
    \u0275\u0275template(14, RequestmaintenanceComponent_div_24_div_2_option_14_Template, 2, 2, "option", 50);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3("Showing ", ctx_r2.getPageStart("completed"), " to ", ctx_r2.getPageEnd("completed"), " of ", ctx_r2.getTotalItems("completed"), " requests");
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.completedPage === 1);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.completedPage === 1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.completedPage);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r2.completedPage === ctx_r2.getTotalPages("completed"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.completedPage === ctx_r2.getTotalPages("completed"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", ctx_r2.rowsPerPage);
...
function RequestmaintenanceComponent_div_24_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52);
    \u0275\u0275text(1, "No completed requests found");
    \u0275\u0275elementEnd();
  }
}
function RequestmaintenanceComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275template(1, RequestmaintenanceComponent_div_24_table_1_Template, 15, 2, "table", 30)(2, RequestmaintenanceComponent_div_24_div_2_Template, 15, 10, "div", 31)(3, RequestmaintenanceComponent_div_24_div_3_Template, 2, 0, "div", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredCompletedItems.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredCompletedItems.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.filteredCompletedItems.length === 0);
...
function RequestmaintenanceComponent_div_34_option_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 51);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const tech_r32 = ctx.$implicit;
    \u0275\u0275property("value", tech_r32.userId);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", tech_r32.fullName, " ");
  }
}
function RequestmaintenanceComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r31 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 13)(1, "label", 14);
    \u0275\u0275text(2, "Technician *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "select", 63);
    \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_div_34_Template_select_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r31);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.approveFormData.technicianId, $event) || (ctx_r2.approveFormData.technicianId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(4, "option", 64);
    \u0275\u0275text(5, "-- Select Technician --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, RequestmaintenanceComponent_div_34_option_6_Template, 2, 2, "option", 50);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.approveFormData.technicianId);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", ctx_r2.technicians);
  }
}
function RequestmaintenanceComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "label", 14);
    \u0275\u0275text(2, "Assigned Technician");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 65);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("value", ctx_r2.getCurrentUserFullName());
  }
}
function RequestmaintenanceComponent_div_62_Template(rf, ctx) {
  if (rf & 1) {
    const _r33 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 13)(1, "label", 14);
    \u0275\u0275text(2, "Expected Reading");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 66);
    \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_div_62_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r33);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.confirmFormData.expectedReading, $event) || (ctx_r2.confirmFormData.expectedReading = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.confirmFormData.expectedReading);
  }
}
function RequestmaintenanceComponent_div_63_Template(rf, ctx) {
  if (rf & 1) {
    const _r34 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 13)(1, "label", 14);
    \u0275\u0275text(2, "Actual Reading");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 67);
    \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_div_63_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r34);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.confirmFormData.actualReading, $event) || (ctx_r2.confirmFormData.actualReading = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.confirmFormData.actualReading);
  }
}
var RequestmaintenanceComponent = class _RequestmaintenanceComponent {
  maintenanceService;
  messageService;
  authService;
  items = [];
  ...
  technicians = [];
  approveFormData = { technicianId: null, reason: "", scheduledAt: null };
  confirmFormData = {
    reason: "",
    actionTaken: "",
    observations: "",
  ...
  selectedItem = null;
  constructor(maintenanceService, messageService, authService) {
    this.maintenanceService = maintenanceService;
    this.messageService = messageService;
    this.authService = authService;
  }
  ...
  isCurrentUserTechnician(technicianUserId) {
    const currentUser = this.authService.getCurrentUser();
  ...
  getPrioritySeverity(priorityLevel) {
  ...
  get filteredPendingItems() {
    ...
    return this.pendingItems.filter((item) => {
      ...
      return formattedId.includes(searchLower) || maintenanceName.includes(searchLower) || maintenanceType.includes(searchLower) || serviceName.includes(searchLower) || priority.includes(searchLower) || status.includes(searchLower) || requestedBy.includes(searchLower) || rawId.includes(searchLower);
    });
  }
  get filteredScheduledItems() {
    const searchLower = this.searchValue.toLowerCase().trim();
  ...
  getTotalPages(tab) {
    let total = 0;
    if (tab === "pending")
      total = this.filteredPendingItems.length;
    else if (tab === "scheduled")
      total = this.filteredScheduledItems.length;
    else if (tab === "inprogress")
      total = this.filteredInProgressItems.length;
    else if (tab === "completed")
      total = this.filteredCompletedItems.length;
  ...
  getTotalItems(tab) {
    if (tab === "pending")
      return this.filteredPendingItems.length;
    if (tab === "scheduled")
      return this.filteredScheduledItems.length;
    if (tab === "inprogress")
      return this.filteredInProgressItems.length;
  ...
  getPriorityClass(priorityLevel) {
    const level = priorityLevel?.toLowerCase() || "";
    if (level.includes("critical") || level.includes("urgent") || level.includes("high")) {
      return "danger";
    } else if (level.includes("medium") || level.includes("moderate")) {
  ...
  formatId(id) {
    if (!id)
      return "";
    return id.split("-").map((segment) => segment.replace(/[^0-9]/g, "")).join("-");
  }
  onSelectionChange(event) {
  }
  approve(item) {
  ...
  loadTechnicians(campusId) {
    this.maintenanceService.getLabTechnicians().subscribe({
      next: (data) => {
        this.technicians = data.map((tech) => __spreadProps(__spreadValues({}, tech), {
          fullName: [tech.firstName, tech.middleName, tech.lastName].filter((name) => name && name.trim()).join(" ")
        }));
      },
      error: (error) => {
        this.technicians = [];
        import_sweetalert23.default.fire("Failed to load technicians");
      }
    });
  }
  confirmApprove() {
    if (!this.approveFormData.technicianId) {
      import_sweetalert23.default.fire("Technician is required");
      return;
    }
    if (!this.approveFormData.scheduledAt) {
      import_sweetalert23.default.fire("Scheduled Date is required");
      return;
    }
    if (!this.approveFormData.reason.trim()) {
      import_sweetalert23.default.fire("Reason is required");
      return;
    }
  ...
  decline(item) {
    import_sweetalert23.default.fire({
      ...
      preConfirm: () => {
        ...
        if (!reason) {
          import_sweetalert23.default.showValidationMessage("Please enter a reason for declining");
          return false;
        }
        return reason;
      }
  ...
  openNewDialog() {
    import_sweetalert23.default.fire({
      ...
      showCancelButton: true,
      preConfirm: () => {
        const maintenanceName = document.getElementById("maintenanceName")?.value.trim();
        if (!maintenanceName) {
          import_sweetalert23.default.showValidationMessage("Maintenance name is required");
          return false;
        }
      ...
      next: (data) => {
        import_sweetalert23.default.fire({
          ...
          preConfirm: () => {
            const maintenanceName = document.getElementById("maintenanceName")?.value.trim();
            if (!maintenanceName) {
              import_sweetalert23.default.fire("Maintenance name is required");
              return false;
            }
            return { maintenanceName };
          }
...
`;
  ...
  holdMaintenance(item) {
    import_sweetalert23.default.fire({
      ...
      preConfirm: () => {
        ...
        if (!reason) {
          import_sweetalert23.default.showValidationMessage("Please enter a reason for holding the work");
          return false;
        }
        return reason;
      }
  ...
  cancelMaintenance(item) {
    import_sweetalert23.default.fire({
      ...
      preConfirm: () => {
        ...
        if (!reason) {
          import_sweetalert23.default.showValidationMessage("Please enter a reason for cancelling");
          return false;
        }
        return reason;
      }
  ...
  static \u0275fac = function RequestmaintenanceComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _RequestmaintenanceComponent)(\u0275\u0275directiveInject(MaintenanceService), \u0275\u0275directiveInject(MessageService), \u0275\u0275directiveInject(AuthService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RequestmaintenanceComponent, selectors: [["app-requestmaintenance"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 69, vars: 33, consts: [["start", ""], ["end", ""], [1, "maintenance-container"], ["styleClass", "mb-4"], [1, "tabs-container"], [1, "tab-headers"], [1, "tab-header", 3, "click"], [1, "tab-content"], ["class", "table-wrapper", 4, "ngIf"], [1, "modal-overlay", 3, "click"], [1, "modal", 3, "click"], [1, "modal-header"], [1, "modal-body"], [1, "form-group"], [1, "form-label"], ["type", "date", 1, "form-control", 3, "ngModelChange", "ngModel"], ["class", "form-group", 4, "ngIf"], ["placeholder", "Enter reason...", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "modal-footer"], [1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click"], ["placeholder", "Describe the action taken...", 1, "form-control", 3, "ngModelChange", "ngModel"], ["placeholder", "Enter observations...", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "flex", "items-center", "gap-2"], ["label", "Delete Selected", "icon", "pi pi-trash", "severity", "secondary", "outlined", "", 3, "disabled", "onClick", 4, "ngIf"], ["label", "Delete Selected", "icon", "pi pi-trash", "severity", "secondary", "outlined", "", 3, "onClick", "disabled"], ["label", "Export", "icon", "pi pi-upload", "severity", "secondary", 3, "onClick"], ["styleClass", "pi pi-search"], ["pInputText", "", "type", "text", "placeholder", "Search maintenance requests...", 3, "ngModelChange", "input", "ngModel"], [1, "table-wrapper"], [4, "ngIf"], ["class", "paginator", 4, "ngIf"], ["class", "empty-message", 4, "ngIf"], [2, "width", "3rem"], ["type", "checkbox", 3, "change", "checked"], [4, "ngFor", "ngForOf"], [1, "tag", 3, "ngClass"], [1, "tag", "tag-info"], [1, "actions"], ["icon", "pi pi-check", "severity", "success", "pTooltip", "Approve", 3, "onClick", "rounded", "text"], ["icon", "pi pi-times", "severity", "danger", "pTooltip", "Decline", 3, "onClick", "rounded", "text"], [1, "paginator"], [1, "paginator-info"], [3, "click", "disabled"], [1, "pi", "pi-angle-double-left"], [1, "pi", "pi-angle-left"], [1, "page-number"], [1, "pi", "pi-angle-right"], [1, "pi", "pi-angle-double-right"], [3, "change", "value"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "empty-message"], ["icon", "pi pi-play", "severity", "success", "pTooltip", "Start Maintenance", 3, "onClick", "rounded", "text"], ["icon", "pi pi-ban", "severity", "danger", "pTooltip", "Cancel", 3, "onClick", "rounded", "text"], [1, "tag", "tag-warning"], ["icon", "pi pi-play-circle", "severity", "success", "pTooltip", "Resume", 3, "onClick", "rounded", "text"], ["icon", "pi pi-check", "severity", "success", "pTooltip", "Complete", 3, "onClick", "rounded", "text"], ["icon", "pi pi-pause", "severity", "warn", "pTooltip", "Hold", 3, "onClick", "rounded", "text"], [1, "tag", "tag-success"], ["icon", "pi pi-eye", "severity", "info", "pTooltip", "View", 3, "onClick", "rounded", "text"], ["icon", "pi pi-trash", "severity", "danger", "pTooltip", "Delete", 3, "rounded", "text", "onClick", 4, "ngIf"], ["icon", "pi pi-trash", "severity", "danger", "pTooltip", "Delete", 3, "onClick", "rounded", "text"], [1, "form-control", 3, "ngModelChange", "ngModel"], ["value", ""], ["type", "text", "disabled", "", 1, "form-control", 3, "value"], ["type", "text", "placeholder", "Enter expected reading...", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "Enter actual reading...", 1, "form-control", 3, "ngModelChange", "ngModel"]], template: function RequestmaintenanceComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275element(0, "p-toast");
      \u0275\u0275elementStart(1, "div", 2)(2, "p-toolbar", 3);
      \u0275\u0275template(3, RequestmaintenanceComponent_ng_template_3_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(5, RequestmaintenanceComponent_ng_template_5_Template, 5, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "div", 4)(8, "div", 5)(9, "button", 6);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_button_click_9_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onActiveIndexChange(0));
      });
      \u0275\u0275text(10, "Pending");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "button", 6);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_button_click_11_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onActiveIndexChange(1));
      });
      \u0275\u0275text(12, "Scheduled");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "button", 6);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_button_click_13_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onActiveIndexChange(2));
      });
      \u0275\u0275text(14, "In Progress");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "button", 6);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_button_click_15_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onActiveIndexChange(3));
      });
      \u0275\u0275text(16, "Completed");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "div", 7);
      \u0275\u0275template(18, RequestmaintenanceComponent_div_18_Template, 4, 3, "div", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(19, "div", 7);
      \u0275\u0275template(20, RequestmaintenanceComponent_div_20_Template, 4, 3, "div", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "div", 7);
      \u0275\u0275template(22, RequestmaintenanceComponent_div_22_Template, 4, 3, "div", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "div", 7);
      \u0275\u0275template(24, RequestmaintenanceComponent_div_24_Template, 4, 3, "div", 8);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(25, "div", 9);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_div_click_25_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.approveModalVisible = false);
      });
      \u0275\u0275elementStart(26, "div", 10);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_div_click_26_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView($event.stopPropagation());
      });
      \u0275\u0275elementStart(27, "div", 11);
      \u0275\u0275text(28, "Assign Technician");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "div", 12)(30, "div", 13)(31, "label", 14);
      \u0275\u0275text(32, "Scheduled Date *");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "input", 15);
      \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_Template_input_ngModelChange_33_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.approveFormData.scheduledAt, $event) || (ctx.approveFormData.scheduledAt = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275template(34, RequestmaintenanceComponent_div_34_Template, 7, 2, "div", 16)(35, RequestmaintenanceComponent_div_35_Template, 4, 1, "div", 16);
      \u0275\u0275elementStart(36, "div", 13)(37, "label", 14);
      \u0275\u0275text(38, "Details *");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(39, "textarea", 17);
      \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_Template_textarea_ngModelChange_39_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.approveFormData.reason, $event) || (ctx.approveFormData.reason = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(40, "div", 18)(41, "button", 19);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_button_click_41_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.approveModalVisible = false);
      });
      \u0275\u0275text(42, "Cancel");
      ...
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_button_click_43_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.confirmApprove());
      });
      \u0275\u0275text(44, "Assign");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(45, "div", 9);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_div_click_45_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.confirmModalVisible = false);
      });
      \u0275\u0275elementStart(46, "div", 10);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_div_click_46_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView($event.stopPropagation());
      });
      \u0275\u0275elementStart(47, "div", 11);
      \u0275\u0275text(48, "Complete Maintenance Request");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(49, "div", 12)(50, "div", 13)(51, "label", 14);
      \u0275\u0275text(52, "Reason *");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(53, "textarea", 17);
      \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_Template_textarea_ngModelChange_53_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.confirmFormData.reason, $event) || (ctx.confirmFormData.reason = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(54, "div", 13)(55, "label", 14);
      \u0275\u0275text(56, "Action Taken");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(57, "textarea", 21);
      \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_Template_textarea_ngModelChange_57_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.confirmFormData.actionTaken, $event) || (ctx.confirmFormData.actionTaken = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(58, "div", 13)(59, "label", 14);
      \u0275\u0275text(60, "Observations");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(61, "textarea", 22);
      \u0275\u0275twoWayListener("ngModelChange", function RequestmaintenanceComponent_Template_textarea_ngModelChange_61_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.confirmFormData.observations, $event) || (ctx.confirmFormData.observations = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275template(62, RequestmaintenanceComponent_div_62_Template, 4, 1, "div", 16)(63, RequestmaintenanceComponent_div_63_Template, 4, 1, "div", 16);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(64, "div", 18)(65, "button", 19);
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_button_click_65_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.confirmModalVisible = false);
      });
      \u0275\u0275text(66, "Cancel");
      ...
      \u0275\u0275listener("click", function RequestmaintenanceComponent_Template_button_click_67_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.confirmCompletion());
      });
      \u0275\u0275text(68, "Complete");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(9);
      \u0275\u0275classProp("active", ctx.activeTabIndex === 0);
      \u0275\u0275advance(2);
      \u0275\u0275classProp("active", ctx.activeTabIndex === 1);
      \u0275\u0275advance(2);
      \u0275\u0275classProp("active", ctx.activeTabIndex === 2);
      \u0275\u0275advance(2);
      \u0275\u0275classProp("active", ctx.activeTabIndex === 3);
      \u0275\u0275advance(2);
      \u0275\u0275classProp("active", ctx.activeTabIndex === 0);
      \u0275\u0275advance();
      ...
      \u0275\u0275property("ngIf", !ctx.loading);
      \u0275\u0275advance();
      \u0275\u0275classProp("active", ctx.approveModalVisible);
      \u0275\u0275advance(8);
      \u0275\u0275twoWayProperty("ngModel", ctx.approveFormData.scheduledAt);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isCampusAdmin());
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isLabTech());
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.approveFormData.reason);
      \u0275\u0275advance(6);
      \u0275\u0275classProp("active", ctx.confirmModalVisible);
      \u0275\u0275advance(8);
      \u0275\u0275twoWayProperty("ngModel", ctx.confirmFormData.reason);
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.confirmFormData.actionTaken);
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.confirmFormData.observations);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isCalibrationRequest());
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isCalibrationRequest());
    }
  }, dependencies: [CommonModule, NgClass, NgForOf, NgIf, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, ToolbarModule, Toolbar, ButtonModule, Button, IconFieldModule, IconField, InputIconModule, InputIcon, InputTextModule, InputText, ToastModule, Toast, TooltipModule, Tooltip, DatePipe], styles: [`
...
.tab-header[_ngcontent-%COMP%]:hover {
  color: #1f2937;
  background: #f3f4f6;
}
...
.paginator[_ngcontent-%COMP%]   select[_ngcontent-%COMP%] {
...
.paginator[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover:not(:disabled) {
...
.paginator[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {
  font-size: 14px;
}
...
.paginator[_ngcontent-%COMP%]   .page-number[_ngcontent-%COMP%] {
  width: 2.5rem;
  height: 2.5rem;
  display: inline-flex;
  align-items: center;
...
/*# sourceMappingURL=requestmaintenance.component.css.map */`] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(RequestmaintenanceComponent, [{
    type: Component,
    args: [{ selector: "app-requestmaintenance", standalone: true, imports: [CommonModule, FormsModule, ToolbarModule, ButtonModule, IconFieldModule, InputIconModule, InputTextModule, ToastModule, TooltipModule], schemas: [CUSTOM_ELEMENTS_SCHEMA], template: `
        <p-toast />
    ...
    `, providers: [MessageService], styles: [`/* angular:styles/component:scss;c283612fcbca683ba644d75c94604d2da287deae25f5fb8cdcc923c4025cf979;D:/Capstone Projects/LAMS-COPY/src/app/pages/requestmaintenance/requestmaintenance/requestmaintenance.component.ts */
...
/*# sourceMappingURL=requestmaintenance.component.css.map */
`] }]
  }], () => [{ type: MaintenanceService }, { type: MessageService }, { type: AuthService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RequestmaintenanceComponent, { className: "RequestmaintenanceComponent", filePath: "src/app/pages/requestmaintenance/requestmaintenance/requestmaintenance.component.ts", lineNumber: 685 });
})();
...
// src/app/pages/service/activities.service.ts
var ActivitiesService = class _ActivitiesService {
  ...
  getMyLogs() {
    return this.http.get(`${environment.apiUrl}/activities/my-logs`);
  }
  getSystemLogs() {
    return this.http.get(`${environment.apiUrl}/activities/system-logs`);
  }
  static \u0275fac = function ActivitiesService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ActivitiesService)(\u0275\u0275inject(HttpClient));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ActivitiesService, factory: _ActivitiesService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ActivitiesService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
//# sourceMappingURL=chunk-SB5VYSY6.js.map
